        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection>
            ...
            <p className="text-white/70 max-w-2xl mx-auto text-lg">
              Создаём гастрономические шедевры для ваших самых важных мероприятий с 2013 года
            </p>
          </AnimatedSection>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mt-8">
            ...
            <AnimatedSection delay={0.2}>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  Nilov Catering был основан в 2013 году шеф-поваром Николаем Ниловым с простой, но амбициозной целью — изменить представление о выездном питании в Москве.
                </p>
                <p>
                  За более чем 12 лет работы мы организовали свыше 850 мероприятий — от камерных семейных ужинов на 10 человек до масштабных корпоративов на 500 гостей. Каждый заказ для нас — это уникальный проект, требующий индивидуального подхода.
                </p>
                <p>
