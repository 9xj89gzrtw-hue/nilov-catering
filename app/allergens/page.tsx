...
const ALLERGENS_14 = [
  ...
  { name: 'Кунжут', emoji: '🍥', details: 'Семена и паста (тахини). В выпечке, азиатских блюдах, хумусе.' },
      ...
      <div className="container-site max-w-4xl">
        ...
        <div className="mb-8 p-6 rounded-2xl border-2 border-purple-200 bg-purple-50">
          ...
          <ul className="text-sm text-foreground space-y-1.5 mb-3">
            ...
            <li> <span className="font-medium">Без сладкого стола по умолчанию</span> — заменяем на сырно-фруктовую тарелку (брусника, черника, твёрдые сыры, орехи — если нет анафилаксии)</li>
        ...
        <div className="mb-8 p-6 rounded-2xl border-2 border-orange-200 bg-orange-50">
          ...
          <ul className="text-sm text-foreground space-y-1.5 mb-3">
            ...
            <li> <span className="font-medium">Маркировка каждого блюда</span> на событии — этикетка с составом на каждом блюде</li>
