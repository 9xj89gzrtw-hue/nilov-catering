...
const ALLERGENS_14 = [
  { name: 'Глютен (злаки)', emoji: '⚠️', details: 'Пшеница, рожь, ячмень, овёс и их производные. Для целиакии — отдельная линия кухни, тестирование <20 ppm.' },
  { name: 'Ракообразные', emoji: '⚠️', details: 'Креветки, крабы, омары, лангустины. Встречаются в морепродуктах, соусах, бульонах.' },
  { name: 'Яйца', emoji: '⚠️', details: 'Белок и желток. В выпечке, соусах (майонез), блюдах с обвалкой.' },
  { name: 'Рыба', emoji: '⚠️', details: 'Все виды рыб. Встречается в супах, соусах (ворчестер), пастах.' },
  { name: 'Арахис', emoji: '⚠️', details: 'Бобовые, часто называют орехом. В азиатской кухне, десертах, марципане. Анафилаксия — частая.' },
  { name: 'Соя', emoji: '⚠️', details: 'Соевый соус, тофу, мисо, эдамаме. В азиатских блюдах, веган-меню.' },
  { name: 'Молоко', emoji: '⚠️', details: 'Коровье, козье, овечье. Лактоза, казеин, сыворотка. В десертах, соусах.' },
  { name: 'Орехи', emoji: '⚠️', details: 'Лесной, грецкий, кедровый, миндаль, кешью, фисташка, пекан, макадамия, бразильский. Анафилаксия — частая.' },
  { name: 'Сельдерей', emoji: '⚠️', details: 'Корень и стебель. В супах, бульонах, салатах. Часто скрытый аллерген.' },
  { name: 'Горчица', emoji: '⚠️', details: 'Семена и паста. В соусах, маринадах, мясных изделиях.' },
  { name: 'Кунжут', emoji: '⚠️', details: 'Семена и паста (тахини). В выпечке, азиатских блюдах, хумусе.' },
  { name: 'Сульфиты', emoji: '⚠️', details: 'Диоксид серы и сульфиты. В вине, сухофруктах, переработанных продуктах.' },
  { name: 'Люпин', emoji: '⚠️', details: 'Бобовые, родственные арахису. В муке, выпечке, готовых продуктах.' },
  { name: 'Моллюски', emoji: '⚠️', details: 'Устрицы, мидии, кальмары, осьминоги. В морепродуктах, паэлье, ризотто.' },
];
      ...
      <div className="container-site max-w-4xl">
        ...
        <div className="mb-8 p-6 rounded-2xl border-2 border-orange-200 bg-orange-50">
          ...
          <ul className="text-sm text-foreground space-y-1.5 mb-3">
            ...
            <li> <span className="font-medium">Веган-меню = безопасный выбор</span> по умолчанию (без молока, без яиц, без мёда) — 30 веган-блюд в каталоге</li>
          </ul>
          <p className="text-sm text-muted-foreground">
