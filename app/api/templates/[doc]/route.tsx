  ...
  return (
    <Document title="Договор на оказание кейтеринговых услуг — NiloV Catering" author={SITE.legalName}>
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.p}>
          3.3. ИП Нилов Д.И. применяет УСН (без НДС). Для Заказчиков на ОСН, требующих счёт-фактуру с НДС, работы оформляются через налогового агента по предварительному согласованию с Заказчиком.
        </Text>
        <Text style={styles.p}>
