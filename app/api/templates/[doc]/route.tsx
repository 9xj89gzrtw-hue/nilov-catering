    ...
    <Document title="Договор на оказание кейтеринговых услуг — NiloV Catering" author={SITE.legalName}>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.list}>
          ...
          <Text style={styles.listItem}>2.1.5. По запросу Заказчика предоставить: программу производственного контроля (ППК), бракеражный журнал, полис страхования ГО (базовый лимит 5 000 000 ₽).</Text>
        </View>
        ...
        <Text style={styles.p}>
          3.3. ИП Нилов Д.И. применяет УСН (без НДС). Для Заказчиков на ОСН, требующих счёт-фактуру с НДС, работы оформляются через партнёрское ООО по запросу.
        </Text>
        <Text style={styles.p}>
  ...
  return (
    <Document title="SLA — NiloV Catering" author={SITE.legalName}>
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.p}>
          2.3. Подача блюд — по согласованному таймингу (Приложение к Спецификации). Допустимое отклонение ±15 минут для всех форматов. Превышение — штраф по п. 4.2.
        </Text>
        <Text style={styles.p}>
        ...
        <Text style={styles.p}>4.2. Опоздание тайминга подачи более ±15 минут — штраф 1% за каждую минуту опоздания (максимум 30% от стоимости события). Единая формула для банкета, фуршета, кофе-брейка, доставки.</Text>
