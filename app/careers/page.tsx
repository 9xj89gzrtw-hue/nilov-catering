...
export default function CareersPage() {
  return (
    <main id="main" className="pt-24 pb-20"><div className="container-site max-w-2xl">
      ...
      {[
        { t: 'Шеф-повар', d: 'Опыт от 12 лет. Французская и итальянская кухня. Работа на выезде.' },
        { t: 'Менеджер событий', d: 'Опыт в сфере мероприятий. Коммуникабельность, ответственность, авто.' },
