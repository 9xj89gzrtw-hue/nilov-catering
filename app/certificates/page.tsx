...
const CERTIFICATES = [
  ...
  },
  {
    ...
    note: 'Скан декларации (PDF, 0.8 МБ) предоставляется по запросу на info@odaeda.ru в течение 30 минут в рабочее время. Номер декларации опубликован для онлайн-проверки в реестре Росаккредитации.',
  },
  {
    icon: '🍚',
  ...
  },
  {
    ...
    note: 'Сертификат Совета муфтиев России — рег. № СМР-Халяль-2024-078, действует до 31.12.2025. 📄 <a href="/certificates/halal-2024-078.pdf" target="_blank" rel="noopener" class="text-gold-text underline">Скачать скан сертификата (PDF, 1.2 МБ)</a>. Сертификация обновляется ежегодно.',
  },
  {
    icon: '🌾',
