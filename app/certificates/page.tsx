...
export const metadata: Metadata = {
  ...
  description: '152-ФЗ «О персональных данных», ТР ТС 022/2011 «О безопасности пищевой продукции», декларации соответствия.',
};
    ...
    <main className="pt-24 pb-20"><div className="container-site max-w-2xl">
      ...
      <div className="space-y-6">
        {[
          ...
          {
            title: 'ТР ТС 022/2011 «О безопасности пищевой продукции»',
