...
const CERTIFICATES = [
  ...
  },
  {
    ...
    details: [
      ...
      'Депозит 30% бронирует дату (входит в предоплату). Предоплата 50% по счёту, постоплата 50% — в течение 5 рабочих дней после события. Для постоянных B2B-клиентов (3+ событий) — отсрочка 7-14 дней.',
    ],
