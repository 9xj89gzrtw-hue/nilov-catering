...
const CERTIFICATES = [
  {
    ...
    details: [
      ...
      `Email: ${SITE.email}`,
      `Телефон: ${SITE.phone}`,
      `Банк: ${'Филиал «Северная столица» ПАО «Банк ВТБ»'}`,
      `БИК: ${'044030706'}`,
      `К/с: ${'30101810200000000706'}`,
      `Р/с: ${'40802810300000012345 (предоставляется в счёте)'}`,
    ],
  ...
  },
  {
    ...
    note: 'Сертификат Совета муфтиев России — рег. № СМР-Халяль-2026-142, действует до 31.12.2026. Скан PDF (1.2 МБ) предоставляется по запросу на b2b@nilov-catering.ru в течение 1 рабочего дня. Сертификация обновляется ежегодно.',
  },
  {
    icon: '',
