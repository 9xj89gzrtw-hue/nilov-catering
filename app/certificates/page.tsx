...
const CERTIFICATES = [
  ...
  },
  {
    ...
    note: 'Сертификат Совета муфтиев России — рег. № СМР-Халяль-2024-078, действует до 31.12.2025. Скан сертификата (PDF, 1.2 МБ) предоставляется по запросу на info@odaeda.ru в течение 30 минут в рабочее время. Сертификация обновляется ежегодно.',
  },
  {
    icon: '🌾',
  ...
  },
  {
    ...
    details: [
      ...
      'Счёт на оплату — для юр.лиц (безналичный расчёт). ИП Нилов Д.И. применяет УСН (без НДС). Для плательщиков НДС — работаем через партнёрское ООО (по запросу).',
