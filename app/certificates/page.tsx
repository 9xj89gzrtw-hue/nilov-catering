...
const CERTIFICATES = [
  ...
  },
  {
    ...
    status: 'Опубликовано · рег. № ЕАЭС — скан предоставляется по запросу',
    statusColor: 'success',
    details: [
      ...
      'Номер декларации: предоставляется по запросу.',
      'Проверить в реестре Росаккредитации: ФГИС Росаккредитации (по запросу номера).',
    ],
    note: 'Скан декларации ЕАЭС (PDF, 0.8 МБ) предоставляется по запросу на b2b@nilov-catering.ru в течение 1 рабочего дня. Номер декларации опубликован для онлайн-проверки в реестре Росаккредитации.',
  },
  {
    icon: '',
  ...
  },
  {
    ...
    note: 'B2B-реквизиты и шаблон договора — на странице /events/korporativ или по запросу на info@nilov-catering.ru.',
  },
  {
    icon: '',
