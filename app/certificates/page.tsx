...
const CERTIFICATES = [
  ...
  },
  {
    ...
    note: 'Сертификат Совета муфтиев России (номер и скан предоставляются по запросу на info@odaeda.ru в течение 30 минут в рабочее время). Сертификация обновляется ежегодно.',
  },
  {
    icon: '🌾',
