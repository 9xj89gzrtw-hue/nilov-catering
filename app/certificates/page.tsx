...
const CERTIFICATES = [
  ...
  },
  {
    ...
    details: [
      ...
      'Счёт на оплату — для юр.лиц (безналичный расчёт). ИП Нилов Д.И. применяет УСН (без НДС). Для плательщиков НДС работаем с НДС. Полные реквизиты — на странице Контакты.',
