...
const CERTIFICATES = [
  ...
  },
  {
    ...
    note: 'Сертификат Совета муфтиев России — рег. № СМР-Халяль-2026-142, действует до 31.12.2026. 📄 <a href="/certificates/halal-2026-142.pdf" target="_blank" rel="noopener" class="text-gold-text underline">Скачать скан сертификата (PDF, 1.2 МБ)</a>. Сертификация обновляется ежегодно.',
  },
  {
    icon: '🌾',
  ...
  },
  {
    ...
    details: [
      ...
      'Счёт на оплату — для юр.лиц (безналичный расчёт). ИП Нилов Д.И. применяет УСН (без НДС). Для плательщиков НДС — работаем через партнёрское ООО на ОСН (Для плательщиков НДС работаем через партнёрское ООО «ОдаЕда» (ИНН 7816583688, ОГРН 1147847107650). Реквизиты доступны на странице Контакты.).',
