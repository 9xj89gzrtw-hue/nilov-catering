    ...
    <main id="main" className="pt-24 pb-20">
      <div className="container-site max-w-3xl">
        ...
        <p className="text-muted-foreground mb-8 text-sm">
          Редакция от 1 августа 2026 г. Соответствует 152-ФЗ и ePrivacy Directive (для
          EU-посетителей).
        </p>

        <div className="space-y-8">
          <section>
            <h2 className="font-heading mb-3 text-xl font-medium">1. Что такое cookie</h2>
            <p className="text-sm leading-relaxed">
              Cookie — небольшие текстовые файлы, которые сайт сохраняет в браузере пользователя.
              Они нужны для запоминания настроек, корзины, аналитики и персонализации.
            </p>
          </section>

          <section>
            <h2 className="font-heading mb-3 text-xl font-medium">2. Типы cookie на сайте</h2>
            <div className="overflow-x-auto">
              <table className="w-full border-collapse text-sm">
                <thead>
                  <tr className="border-line border-b">
                    <th className="py-2 pr-4 text-left font-medium">Тип</th>
                    <th className="py-2 pr-4 text-left font-medium">Назначение</th>
                    <th className="py-2 pr-4 text-left font-medium">Срок</th>
                    <th className="py-2 text-left font-medium">Согласие</th>
                  </tr>
                </thead>
                <tbody className="text-foreground/90">
                  ...
                  <tr className="border-line/60 border-b">
                    ...
                    <td className="py-2 pr-4">
                      Microsoft Clarity (тепловые карты, сессионные записи — данные передаются на
                      серверы Microsoft, вне РФ)
                    </td>
                    <td className="py-2 pr-4">13 месяцев</td>
          ...
          <section>
            <h2 className="font-heading mb-3 text-xl font-medium">3. Управление cookie</h2>
            ...
            <ul className="text-foreground/90 mb-3 list-inside list-disc space-y-1.5 text-sm">
              <li>Chrome: Настройки → Конфиденциальность → Файлы cookie</li>
            ...
            <p className="text-sm leading-relaxed">
              3.3. При отключении cookie часть функций сайта (корзина, конструктор меню, размер
              шрифта) может стать недоступна.
            </p>
          </section>

          <section>
            <h2 className="font-heading mb-3 text-xl font-medium">4. Сторонние сервисы</h2>
            <p className="mb-3 text-sm leading-relaxed">
              Сайт использует следующие сторонние сервисы, устанавливающие свои cookie:
            </p>
            <ul className="text-foreground/90 list-inside list-disc space-y-1.5 text-sm">
              ...
              <li>
                Microsoft Clarity (clarity.ms) — тепловые карты и сессионные записи (данные
                передаются на серверы Microsoft, вне РФ — см. Политику конфиденциальности §3.2)
              </li>
          ...
          <section>
            <h2 className="font-heading mb-3 text-xl font-medium">5. Контакты</h2>
            <p className="text-sm leading-relaxed">
