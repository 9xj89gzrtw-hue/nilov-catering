                ...
                <div className="border-line bg-card mb-6 rounded-xl border p-4">
                  <label className="block">
                    ...
                    <input
                      ...
                      className="border-line bg-background focus:border-gold-text rounded-lg border px-3 py-2 text-sm focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#6E5530]"
                    />
                  </label>
                ...
                <div className="mb-4 space-y-3">
                  <div className="grid grid-cols-2 gap-3">
                    <input
                      ...
                      className="border-line bg-card focus:border-gold-text rounded-xl border px-4 py-3 text-sm focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#6E5530]"
                    />
                    <input
                      type="tel"
                  ...
                  <input
                    ...
                    className="border-line bg-card focus:border-gold-text w-full rounded-xl border px-4 py-3 text-sm focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#6E5530]"
                  />
                    ...
                    <div className="border-gold-tint bg-gold-tint/20 space-y-2 rounded-xl border p-3">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <input
                          ...
                          value={cart.contact.entrance}
                          onChange={(e) => cart.setContact({ entrance: e.target.value })}
                          className="border-line bg-card focus:border-gold-text inline-flex min-h-[44px] items-center rounded-lg border px-3 py-2.5 text-sm focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#6E5530]"
                        />
                        <input
                          type="text"
                      ...
                      <input
                        ...
                        value={cart.contact.intercom}
                        onChange={(e) => cart.setContact({ intercom: e.target.value })}
                        className="border-line bg-card focus:border-gold-text inline-flex min-h-[44px] w-full items-center rounded-lg border px-3 py-2.5 text-sm focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#6E5530]"
                      />
                    </div>
                  )}
                  ...
                  <textarea
                    ...
                    className="border-line bg-card focus:border-gold-text min-h-[80px] w-full resize-none rounded-xl border px-4 py-3 text-sm focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#6E5530]"
                  />
                </div>
