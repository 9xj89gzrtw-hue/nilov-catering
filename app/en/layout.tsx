...
export const metadata: Metadata = {
  ...
  openGraph: { locale: 'en_US', title: 'Catering in St. Petersburg — from 390 ₽/guest', description: 'Restaurant-quality catering for any event in St. Petersburg since 2007.' },
};
