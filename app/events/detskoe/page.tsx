...
export const metadata: Metadata = {
  ...
  description:
    "Детский кейтеринг NiloV: Эконом — без орехов; Стандарт/Премиум — с маркировкой. Анафилаксия-протокол: EpiPen, отдельная смена. Мин. 10 (мед. диеты — от 6).",
  alternates: {
      ...
      <div className="container-site max-w-3xl">
        ...
        >
          ...
          <p className="mb-3 text-sm text-red-900">
            ...
            (арахис, лесной, кедровый, грецкий) — по умолчанию. В пакетах «Стандарт» и «Премиум»
        ...
        >
          ...
          <p className="mb-3 text-sm text-purple-900">
            ...
            без добавленного сахара (стевия/эритрит). Если в пакете «Стандарт» или «Премиум»
