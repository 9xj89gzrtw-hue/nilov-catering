          ...
          <div className="grid sm:grid-cols-2 gap-4 text-sm mb-6">
            <div>
              ...
              <ul className="text-muted-foreground space-y-1 text-xs">
                <li>✓ Доставка: точно в согласованное окно (штраф 1% за каждую минуту опоздания, начиная с 1-й; максимум 30% от суммы заказа)</li>
                ...
                <li>✓ Контингенси-план: резервный шеф + транспорт в течение 4 часов</li>
              </ul>
            </div>
            <div>
