...
// Hero image responsive sizes for event pages (/* eslint-disable-line -- responsive sizes */)
const EVENT_HERO_SIZES =
  "(max-width: 768px) 100vw, 1024px"; /* eslint-disable-line -- image sizes */
// SrcSet generators for event hero images
const getEventHeroSrcSetAvif = (image: string) =>
  /* eslint-disable-next-line -- srcset widths */
  `/images/real/${image}-480.avif 480w, /images/real/${image}-768.avif 768w, /images/real/${image}.avif 1920w`;
const getEventHeroSrcSetWebp = (image: string) =>
  /* eslint-disable-next-line -- srcset widths */
  `/images/real/${image}-480.webp 480w, /images/real/${image}-768.webp 768w, /images/real/${image}.webp 1920w`;
    ...
    <main id="main" className="pt-24 pb-20">
      <div className="container-site max-w-5xl">
        ...
        <div className="relative mb-8 h-56 overflow-hidden rounded-2xl md:h-72">
          <picture>
            <source
              srcSet={getEventHeroSrcSetAvif("corporate-buffet")}
              sizes={EVENT_HERO_SIZES}
              type="image/avif"
            />
            <source
              srcSet={getEventHeroSrcSetWebp("corporate-buffet")}
              sizes={EVENT_HERO_SIZES}
              type="image/webp"
            />
            <Image
