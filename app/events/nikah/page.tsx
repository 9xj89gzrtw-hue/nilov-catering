      ...
      <div className="container-site max-w-4xl">
        ...
        <section className="mb-10">
          ...
          <div className="grid sm:grid-cols-2 gap-3">
            {[
              { t: 'Сертификат халяль', d: 'Совет муфтиев России, рег. № СМР-Халяль-2026-142. Действует до 31.12.2026.' },
              { t: 'Отдельное оборудование', d: 'Полностью раздельные линии: ножи, доски, посуда, плиты. Без кросс-контаминации.' },
              { t: 'Забой по обряду зибха', d: 'С произнесением такмира (tasmiya). Поставщик — сертифицированная бойня Дагестана.' },
