...
const EVENTS = [
  ...
  { title: 'Свадьбы', href: '/events/svadba', desc: 'Меню, сервировка, торт, флористика. Полный цикл подготовки.', price: 'от 4 470 ₽/гость' },
  { title: 'Выпускные', href: '/events/vypusknoy', desc: 'Фуршеты и банкеты для школ и вузов. Бюджетные решения.', price: 'от 2 450 ₽/гость' },
