...
const EVENTS = [
  { title: 'Корпоративы', href: '/events/korporativ', desc: 'Бизнес-ланчи, фуршеты, банкеты для компаний. От 10 до 800+ человек (с расширением производственных мощностей).', price: 'от 2 450 ₽/гость', primary: true },
  { title: 'Свадьбы', href: '/events/svadba', desc: 'Меню, сервировка, торт, флористика. Полный цикл подготовки.', price: 'от 3 950 ₽/гость' },
  { title: 'Выпускные', href: '/events/vypusknoy', desc: 'Фуршеты и банкеты для школ и вузов. B2B: документы для Роспотребнадзор.', price: 'от 2 450 ₽/гость' },
  ...
  { title: 'Юбилеи и годовщины', href: '/events/yubiley', desc: 'Золотая свадьба, юбилей для пожилых гостей. Банкет с посадкой от 15 чел.', price: 'от 59 250 ₽ за 15 чел' },
  ...
  { title: 'Никах и ифтар', href: '/events/nikah', desc: 'Халяль-кейтеринг для мусульманской свадьбы и ифтара. Сертификат Совета муфтиев России.', price: 'от 3 950 ₽/гость' },
  { title: 'Выезд шефа', href: '/events/chef-at-home', desc: 'Шеф-повар и сомелье у вас дома. Ужин на 6–12 гостей.', price: 'от 4 500 ₽/гость' },
];
