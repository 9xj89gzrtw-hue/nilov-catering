...
const EVENTS = [
  { title: 'Корпоративы', href: '/events/korporativ', desc: 'Бизнес-ланчи, фуршеты, банкеты для компаний. От 10 до 800+ человек (через сеть партнёрских кухонь).', price: 'от 2 450 ₽/гость', primary: true },
