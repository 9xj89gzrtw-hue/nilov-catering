...
export const metadata: Metadata = {
  ...
  description: 'Кейсы и видео-рекапы событий NiloV Catering: свадьбы, корпоративы, халяль-банкеты, детские праздники с медицинскими диетами. Реальные отзывы клиентов.',
};
    ...
    <main className="pt-24 pb-20">
      <div className="container-site max-w-2xl">
        ...
        <p className="text-muted-foreground mb-8">
          ...
          кликните на карточку, чтобы прочитать полный отзыв клиента. 4 из 6 кейсов имеют
            ...
            >
              {r.hasVideo ? (
                <div className="aspect-video bg-secondary relative overflow-hidden">
                  ...
                  <span className="absolute top-2 right-2 text-xs bg-black/60 text-white px-2 py-1 rounded">▶ видео</span>
                </div>
              ) : (
        ...
        <div className="mb-8 p-5 rounded-xl border-2 border-gold-text/40 bg-gold-text/5">
          <h2 className="font-heading text-lg font-medium mb-2">🏛 Festival-scale (800+ чел)</h2>
          <p className="text-sm text-foreground/90 mb-2">
            <strong>Корпоративный фестиваль 800 чел × 2 дня (через сеть партнёрских кухонь).</strong>{' '}
            ...
            кухни-партнёра СПб. SLA в договоре (±15 минут, штраф 1%/мин). Страхование 30 млн ₽.
          ...
          <p className="text-xs text-muted-foreground">
            ...
            <Link href="/why-us" className="underline text-gold-text">Подробнее →</Link>
          </p>
        </div>
        ...
        <div className="p-4 rounded-xl border border-line bg-secondary/30 mb-8">
          <p className="text-sm text-muted-foreground">
            ...
            <a href="mailto:info@odaeda.ru" className="underline text-gold-text">info@odaeda.ru</a>{' '}
