    ...
    <main id="main" className="pt-24 pb-20">
      <div className="container-site max-w-2xl">
        ...
        <p className="text-muted-foreground mb-8">
          ...
          видео-иллюстрации форматов (используются одни и те же клипы для нескольких кейсов — это демонстрация стиля, не съёмка с конкретного события).
        </p>
        ...
        <div className="mb-8 p-5 rounded-xl border-2 border-gold-text/40 bg-gold-text/5">
          ...
          <p className="text-sm text-foreground/90 mb-2">
            ...
            4 кофе-брейка + 2 обеда + 1 гала-фуршет × 800 × 2 дня = 11 200 порций. Основной подрядчик —
