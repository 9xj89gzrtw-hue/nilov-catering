...
const FAQS_B2C = [
  {
    ...
    a: "Минимум зависит от формата и тарифа. Кофе-брейк — от 10 гостей × 390 ₽ = 3 900 ₽ (Эконом). Фуршет — от 20 гостей × 2 450 ₽ = 49 000 ₽ (Эконом); Премиум от 20 × 5 950 ₽ = 119 000 ₽. Банкет — от 15 × 3 950 ₽ = 59 250 ₽ (Эконом свадебный); Люкс от 15 × 9 950 ₽ = 149 250 ₽. Точную сумму рассчитает менеджер — оставьте заявку на /contact.",
  },
  {
