      ...
      <div className="container-site max-w-3xl">
        ...
        <div className="relative mb-8" role="search">
          ...
          <input
            ...
            className="border-line bg-background focus:ring-ring focus:border-gold-text w-full rounded-xl border py-3.5 pr-4 pl-12 text-base transition-shadow outline-none focus:ring-2 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#6E5530]"
          />
        </div>
        <script
          dangerouslySetInnerHTML={{
