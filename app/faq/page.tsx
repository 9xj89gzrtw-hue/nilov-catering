...
const FAQS_B2B = [
  ...
  },
  {
    ...
    a: 'Да, поддерживаем закупочные процедуры. Готовим документы для тендера: тех. задание, спецификация, смета, реквизиты. ИНН/ОГРНИП — опубликованы на сайте. Срок подготовки тендерной документации — 1-2 рабочих дня. Связаться с B2B-менеджером: b2b@odaeda.ru, +7 (812) 919-59-11.',
  },
  {
  ...
  },
  {
    ...
    a: 'Да. Мы в СПб, но работаем удалённо с клиентами из Москвы и других городов: поможем найти площадку в СПб, организуем видеодегустацию по Zoom (шеф покажет готовые блюда, расскажет состав), согласуем меню через WhatsApp/Telegram. Договор и ЭДО-документы — электронно. Личная встреча в СПб — по запросу. Связь: +7 (812) 919-59-11, info@odaeda.ru.',
    group: 'b2c',
  },
];
