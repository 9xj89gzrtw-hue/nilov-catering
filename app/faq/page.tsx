...
const FAQS_B2B = [
  ...
  },
  {
    ...
    a: 'Да, для B2B-клиентов с объёмом от 30 гостей — индивидуальный SLA. Метрики: доставка (точно в согласованное окно, штраф 1% за каждую минуту опоздания, максимум 30% от суммы заказа), качество (жалобы ≤5% гостей), компенсация при нарушении (штраф 5-15% от стоимости). Страхование гражданской ответственности — базовый полис 5 000 000 ₽ (для контрактов свыше 5 млн — расширенное покрытие до 30 000 000 ₽ через СОГАЗ/РЕСО/Ингосстрах). Контингенси-план: запасной повар, резервный транспорт, замена поставщика в течение 4 часов.',
  },
  {
  ...
  },
  {
    ...
    a: 'Полис страхования гражданской ответственности: базовый — 5 000 000 ₽ на событие. Для контрактов свыше 5 000 000 ₽ — расширенное покрытие до 30 000 000 ₽ через СОГАЗ / РЕСО-Гарантия / Ингосстрах. Покрытие: ущерб здоровью гостей, имуществу заказчика, порча продуктов. Форс-мажор (пожар, авария на производстве, болезнь шеф-повара) — перенос даты без штрафов. Контингенси-план: резервный шеф, запасной транспорт, замена поставщика в течение 4 часов.',
  },
  {
