...
const FAQS_B2B = [
  ...
  },
  {
    ...
    a: 'Да, для B2B-клиентов с объёмом от 30 гостей — индивидуальный SLA. Метрики: punctuality (доставка точно в согласованное окно, штраф 1% за каждую минуту опоздания, максимум 30% от суммы заказа), качество (жалобы ≤5% гостей), компенсация при нарушении (штраф 5-15% от стоимости). Страхование гражданской ответственности — базовый полис 5 000 000 ₽ (для контрактов свыше 5 млн — расширенное покрытие до 30 000 000 ₽ через СОГАЗ/РЕСО/Ингосстрах). Contingency plan: запасной повар, резервный транспорт, замена поставщика в течение 4 часов.',
  },
  {
