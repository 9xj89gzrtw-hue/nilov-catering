        ...
        <div className="grid grid-cols-2 gap-2 md:gap-4 lg:grid-cols-3">
          {photos.map((p, i) => (
            <button
              ...
              className="border-line bg-secondary group focus:ring-gold-text hover:border-gold-text focus-visible:outline-gold relative cursor-zoom-in overflow-hidden rounded-lg border transition-all hover:shadow-lg focus:ring-2 focus:ring-offset-2 focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 md:rounded-xl"
