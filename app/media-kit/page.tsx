...
export const metadata: Metadata = {
  title: "Медиа-кит",
  description: "Пресс-релизы, логотипы и материалы для СМИ.",
  alternates: {
    canonical: "/media-kit",
    ...
    <main id="main" className="pt-24 pb-20">
      <div className="container-site max-w-xl">
        ...
        <p className="text-muted-foreground mb-8">
          Материалы для журналистов, блогеров и партнёров.
        </p>
        ...
        <div className="grid gap-4">
          {[
            ...
            {
              file: "Фото блюд (подборка)",
              size: "ZIP · по запросу",
              href: "mailto:info@nilov-catering.ru?subject=Фото блюд",
            },
            {
              file: "Фото команды",
              size: "по запросу",
              href: "mailto:info@nilov-catering.ru?subject=Фото команды",
            },
            {
