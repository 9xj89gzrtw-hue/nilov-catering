      ...
      <div className="container-site max-w-4xl">
        ...
        <div className="mb-8 rounded-xl border-2 border-amber-400 bg-amber-50 p-5">
          ...
          <p className="mb-3 text-sm text-amber-900">
            ...
            (арахис, лесной, кедровый, грецкий). В пакетах «Стандарт» и «Премиум» часть десертов
          ...
          <p className="mb-3 text-sm text-amber-900">
            ...
            «Стандарт» и «Премиум». Для ребёнка с СД1 мы заменяем их на сырно-фруктовую тарелку
