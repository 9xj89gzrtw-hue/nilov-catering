                          ...
                          {dish.dietBadges.length > 0 && (
                            <div className="absolute top-1.5 left-1.5 flex gap-0.5">
                              {dish.dietBadges.includes("vegan") && (
                                <span className="bg-diet-vegan rounded px-1 py-0.5 text-[10px] font-bold text-white">
                                  VG
                                </span>
                              )}
                              {dish.dietBadges.includes("gluten-free") && (
                                <span className="bg-diet-gf rounded px-1 py-0.5 text-[10px] font-bold text-white">
                                  GF
                                </span>
                              )}
                            </div>
