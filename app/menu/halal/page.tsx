    ...
    <main className="pt-24 pb-20">
      <div className="container-site max-w-4xl">
        ...
        <p className="text-lg text-muted-foreground mb-6">
          ...
          Сертификат от Совета муфтиев России. Отдельное оборудование, без свинины, без алкоголя.
        </p>
        ...
        <div className="mb-8 p-6 rounded-2xl border-2 border-emerald-200 bg-emerald-50">
          ...
          <div className="grid sm:grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="text-muted-foreground">Совет муфтиев России (ДУМ РФ), Международный центр стандартизации и сертификации «Халяль». Сертификат предоставляется по запросу.</p>
            </div>
            <div>
