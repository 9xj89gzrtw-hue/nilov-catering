        ...
        {dish.dietBadges.length > 0 && (
          <div className="absolute top-2 left-2 z-10 flex gap-1">
            {dish.dietBadges.includes("vegan") && (
              <span className="rounded bg-[#065F46] px-1.5 py-0.5 text-[10px] font-bold text-white">
                VEGAN
              </span>
            )}
            {dish.dietBadges.includes("gluten-free") && (
              <span className="rounded bg-[#B45309] px-1.5 py-0.5 text-[10px] font-bold text-white">
                GF
              </span>
            )}
          </div>
