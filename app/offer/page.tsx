...
export const metadata: Metadata = {
  alternates: { canonical: '/offer', languages: { 'ru': '/offer', 'en': '/en', 'x-default': '/offer' } },
      ...
      <div className="container-site max-w-3xl">
        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <p className="text-sm leading-relaxed">
              3.3. Исполнитель работает на системе налогообложения {LEGAL.taxSystem}. Для Заказчиков на ОСН, требующих счёт-фактуру с НДС, оформляется через партнёрское ООО (по запросу). Документы для юрлиц: счёт, акт, УПД. ЭДО — Контур.Диадок и СБИС.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-sm leading-relaxed">
              5.3. Опоздание доставки — доставка должна быть в согласованное окно: ±15 минут для кофе-брейков и конференций, ±30 минут для банкетов. Штраф 1%
