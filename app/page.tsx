          ...
          <div className="rounded-2xl border-2 border-gold-tint bg-card p-6 md:p-8">
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-6">
              <div>
                ...
                <p className="text-base text-muted-foreground max-w-2xl">
                  ...
                  Полный пакет документов для Роспотребнадзора. SLA, страхование 5 млн ₽ (с расширением до 30 млн), план на случай ЧП.
                </p>
              </div>
            </div>
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
              ...
              <div className="p-3 rounded-lg border border-line bg-background">
                ...
                <p className="text-xs text-muted-foreground">ИП Нилов Д.И. — УСН (без НДС). Работаем с НДС и без НДС.</p>
              </div>
              <div className="p-3 rounded-lg border border-line bg-background">
