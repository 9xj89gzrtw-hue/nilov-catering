      ...
      <div className="container-site max-w-3xl">
        ...
        <div className="border-gold-text/40 bg-gold-text/5 mb-8 rounded-xl border-2 p-6">
          ...
          <p className="text-foreground/90 mb-4 text-sm">
            Если вы агентство мероприятий, продюсерская компания или частный организатор — мы готовы
          ...
          <ul className="text-foreground/90 mb-4 list-inside list-disc space-y-1.5 text-sm">
            ...
            <li>
              ...
              агентства (униформа без логотипов, без материалов с нашим брендом). Возможность
              работы под белым брендом подтверждается в договоре.
            </li>
            <li>
