      ...
      <div className="container-site max-w-3xl">
        ...
        <div className="mb-8 p-6 rounded-xl border-2 border-gold-text/40 bg-gold-text/5">
          ...
          <ul className="text-sm space-y-1.5 list-disc list-inside text-foreground/90 mb-4">
            ...
            <li><span className="font-medium">Договор:</span> либо напрямую с ИП Нилов Д.И. (УСН 6%), либо через партнёрское ООО «ОдаЕда» (ИНН 7816583688, ОСН с НДС) — на выбор агентства</li>
        ...
        <div className="mb-8 p-6 rounded-xl border border-line bg-card">
          ...
          <ul className="text-sm space-y-1.5 list-disc list-inside text-foreground/90 mb-4">
            ...
            <li><span className="font-medium">Техническийрайдер:</span> предоставляем заранее (электричество, вода, кухня, зона разгрузки)</li>
        ...
        <div className="mb-8 p-6 rounded-xl border border-line bg-card">
          ...
          <p className="text-sm text-foreground/90 mb-4">
            Для событий на 500+ гостей мы работаем через сеть партнёрских кухонь СПб. Если у вас
        ...
        <div className="mb-8 p-6 rounded-xl border border-line bg-secondary/30">
          ...
          <ul className="text-sm space-y-2 list-disc list-inside text-foreground/90">
            ...
            <li>Доступ к нашему бренду и репутации (4.8/5 из 17 отзывов)</li>
        ...
        <div className="mt-8 text-xs text-muted-foreground space-y-1">
          ...
          <p>Партнёрское ООО «ОдаЕда» (для плательщиков НДС): ИНН 7816583688, ОГРН 1147847107650</p>
        </div>
      </div>
    </main>
  );
