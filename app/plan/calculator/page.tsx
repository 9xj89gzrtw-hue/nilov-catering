...
export const metadata: Metadata = {
  ...
  title: 'Калькулятор стоимости кейтеринга — рассчитать цену за 30 секунд',
  description: 'Рассчитайте стоимость кейтеринга за 30 секунд. Фуршет от 2 450 ₽/гость, банкет от 3 950 ₽/гость, кофе-брейк от 390 ₽/гость. Всё включено: еда, персонал, посуда, доставка по КАД.',
};
