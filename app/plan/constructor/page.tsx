...
export const metadata: Metadata = {
  ...
  title: "Конструктор меню кейтеринга",
  description:
            ...
            try {
              ...
              if (fmt) {
                ...
                if (card) {
                  ...
                  card.style.background = 'var(--color-gold-tint)';
                  card.setAttribute('aria-current', 'true');
                  // Add checkmark badge
                  var badge = document.createElement('div');
                  badge.textContent = 'Выбрано';
                  badge.style.cssText = 'position:absolute;top:8px;right:8px;background:var(--color-gold);color:white;padding:2px 8px;border-radius:12px;font-size:11px;font-weight:600';
