...
export const metadata: Metadata = {
  ...
  description: 'Соберите меню под ваше событие за 2 минуты. Фуршет от 2 450 ₽/гость, банкет от 3 950 ₽/гость, кофе-брейк от 390 ₽/гость. Мульти-диета: веган + халяль + без глютена + без орехов + всеядные в одном заказе.',
};
      ...
      <div className="container-site max-w-4xl">
        ...
        <div className="mb-8 ml-0 md:ml-11 space-y-4">
          ...
          <p className="text-sm text-muted-foreground ml-0 md:ml-11">
            ...
            с фильтром по диете (веган / халяль / без глютена / без орехов / всеядные). Цена по группам: вы платите только за блюда своей группы.
          </p>
        ...
        <div className="ml-0 md:ml-11 mb-6 p-4 rounded-lg border border-line bg-card">
          ...
          <p className="text-xs text-muted-foreground mt-3">
            Отметьте блюда — менеджер включит их в предложение. Полный интерактивный конструктор с перетаскиванием элементов доступен при включённом JavaScript.
          </p>
          <div className="mt-4">
            <ShareButton
