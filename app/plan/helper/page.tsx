...
function getRecommendation(occasion: string, guests: string): { name: string; price: number; minGuests: number; tier: string; format: string; whatIncluded: string[] } | null {
  ...
  switch (occasion) {
    ...
    case 'Корпоратив':
      if (small) return { name: 'Корпоратив «Фуршет Эконом»', price: 2450, minGuests: 20, tier: 'Эконом', format: 'furshet', whatIncluded: ['Канапе (6 видов), тарталетки, брускетты', 'Сырная тарелка, рыбное ассорти', 'Соки, морсы, лимонады', 'Официант 1/15', 'Фуршетная сервировка'] };
    ...
    case 'Детский праздник':
      return { name: 'Детский праздник «Эконом»', price: 1550, minGuests: 10, tier: 'Эконом', format: 'detskoe', whatIncluded: ['Мини-пицца, наггетсы, канапе без аллергенов', 'Фруктовая тарелка, соки', 'Капкейки, мармелад', 'Аниматор (опц.)', 'Посуда яркая, небьющаяся'] };
    case 'Выпускной':
