...
const FORMATS = [
  ...
  },
  {
    ...
    includes: ['Традиционные блюда', 'Кутья и блины', 'Чай и выпечка', 'Официант 1/15', 'Доставка по КАД'],
  },
  {
    name: 'Веган',
    href: '/menu/vegan',
    ...
    includes: ['12+ веган-блюд', 'Растительные десерты', 'Соки и смузи', 'Официант 1/15', 'Эко-посуда (опц.)'],
  },
  {
    name: 'Шоу-кукинг',
    ...
    includes: ['Живая готовка на глазах', 'Фламбе и шоу-элементы', 'Премиум-ингредиенты', 'Сомелье (опц.)', 'Координатор'],
  },
  {
    name: 'Халяль',
    href: '/menu/halal',
    ...
    includes: ['Сертифицированное мясо', 'Традиционные блюда', 'Без алкоголя', 'Официант 1/12', 'Координатор'],
  },
];
