...
const REVIEWS = [
  ...
  },
  {
    ...
    text: 'Корпоратив на 50 человек с ЭДО (Диадок). ИП Нилов на УСН — без НДС, для нашей бухгалтерии на ОСН предложили партнёрское ООО. Счёт-фактура пришла на следующий день. Документы для бухгалтерии — без замечаний.',
    rating: 5,
    verified: 'Yandex.Maps',
  },
  {
  ...
  {
    author: 'Павел Д.',
    event: 'Конференция 80 чел × 2 дня',
    date: 'Март 2025',
    location: 'Технополис Meta, СПб',
    text: '8 кофе-брейков × 80 чел + 2 обеда. SLA в договоре с punctuality ≤15 мин — выполнили на 100%. Скидку 10% за объём применили без вопросов. ИП на УСН, для нашей бухгалтерии на ОСН — предложили партнёрское ООО.',
    rating: 5,
    verified: 'B2B-договор',
  },
  {
    author: 'Ирина Семёнова',
    event: 'Школьный выпускной 65 чел',
    date: 'Май 2025',
    location: 'Гимназия №209, СПб',
    text: 'Школьный пакет 1 800 ₽/гость на 65 человек = 117 000 ₽ — уложились в школьный бюджет 130к. Полный пакет для Роспот: медкнижки, бракеражный журнал, ППК. Согласование с Роспот прошло без замечаний.',
    rating: 5,
    verified: 'Чек школы',
  },
  {
    author: 'Алексей В.',
    event: 'Корпоратив 70 чел',
    date: 'Июнь 2025',
    location: 'Лофт «Taiga», СПб',
    text: 'Корпоратив 70 чел с B2B-договором. SLA punctuality ≤15 мин — все блюда поданы вовремя. 4 диеты (веган, БГ, без орехов, всеядные) — каждая группа получила своё под-меню. Скидка 5% за объём.',
    rating: 5,
    verified: 'B2B-договор',
  },
  {
    author: 'Марина Д.',
    event: 'День рождения 25 чел',
    date: 'Сентябрь 2025',
    location: 'Дом клиента, СПб',
    text: 'Юбилей мамы 70 лет. Камерный банкет с диетическими опциями (диабет + без глютена). Шеф Дмитрий предложил безглютеновый торт на рисовой муке — мама в восторге. Персонал вежливый, подача неспешная.',
    rating: 5,
    verified: 'Yandex.Maps',
  },
  {
    ...
    event: 'Никях 60 чел',
    date: 'Август 2025',
    location: 'Ресторан «Восток», СПб',
    text: 'Халяль-банкет на никях. Сертификат Совета муфтиев России проверил лично — рег. № СМР-Халяль-2024-078. Забой по зибха. Без алкоголя полностью, винный уксус исключён. Баранина и плов — как дома. Отдельное спасибо за раздельные станции для мужчин и женщин.',
    rating: 5,
    verified: 'Yandex.Maps',
  },
  {
    author: 'Елена К.',
    event: 'Корпоратив 120 чел',
    date: 'Октябрь 2025',
    location: 'ККТ «Космос», СПб',
    text: 'Корпоратив 120 чел с SLA в договоре. Punctuality ≤15 мин — все блюда поданы вовремя. 3 диеты (веган, БГ, всеядные) — каждая группа получила своё под-меню. Скидку 10% за объём применили без вопросов. ИП на УСН, для нашей бухгалтерии на ОСН — партнёрское ООО.',
    rating: 5,
    verified: 'B2B-договор',
  },
  {
    author: 'Светлана Р.',
    event: 'Детский день рождения 8 детей',
    date: 'Ноябрь 2025',
    location: 'Дом клиента, СПб',
    text: 'У дочки целиакия + анафилаксия на орехи. БГ-меню по умолчанию nut-free (на рисовой муке) — впервые не пришлось отдельно просить! БГ торт, БГ капкейки, БГ пицца — всё без орехов. Протокол <20 ppm, отдельная посуда. Дочка счастлива.',
    rating: 5,
    verified: 'Yandex.Maps',
  },
];
