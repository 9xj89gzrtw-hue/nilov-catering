...
const ROUTE_LASTMOD: Record<string, string> = {
  ...
  "/faq": "2026-08-10",
  "/blog": "2026-05-01",
  "/blog/furshet-vs-banket": "2026-07-10",
  "/blog/allergeny-markirovka": "2026-07-01",
  "/blog/svadebnyi-keitering-5-veshei": "2026-06-15",
  "/blog/sezonnoe-menyu-leto-2026": "2026-06-01",
  "/blog/kofe-breik-na-konferentsii": "2026-05-15",
  "/blog/svadebnyy-banquet-chek-list": "2026-01-15",
  "/blog/trendy-furshet-2025": "2026-01-08",
  "/blog/office-catering-tips": "2025-12-20",
  "/blog/halal-catering-traditions": "2025-12-10",
  "/blog/detskiy-prazdnik-pod-klyuch": "2025-11-28",
  "/blog/trendy-katering-2025": "2026-05-15",
  "/blog/detskiy-prazdnik-chek-list": "2026-04-20",
  "/delivery": "2026-06-01",
  "/delivery/order": "2026-06-01",
  "/certificates": "2026-08-11",
  "/venues": "2026-06-01",
  "/tasting": "2026-07-15",
  "/subscribe": "2026-08-10",
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return routes.map((route) => ({
    ...
    changeFrequency:
      route === ""
        ? "weekly"
        : route.startsWith("/events") || route.startsWith("/plan")
          ? "monthly"
          : "yearly",
    priority:
      route === "" ? 1 : route.startsWith("/events") || route.startsWith("/plan") ? 0.8 : 0.5,
  }));
}
