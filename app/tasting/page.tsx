      ...
      <div className="container-site max-w-2xl">
        ...
        <div className="mb-8 p-5 rounded-xl border-2 border-gold-tint bg-gold-tint/10">
          ...
          <ul className="text-sm space-y-2">
            ...
            <li> <strong>5 000 ₽/чел</strong> — расширенная дегустация (6 блюд + вино pairing)</li>
          ...
          <form className="space-y-4" action="/api/quote" method="POST">
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              <div>
                ...
                <input id="name" name="name" required className="w-full rounded-lg border border-line bg-background px-4 py-3 text-base focus:ring-2 focus:ring-ring focus:border-gold-text outline-none focus-visible:outline-2 focus-visible:outline-[#6E5530] focus-visible:outline-offset-2 transition-shadow" />
              </div>
              <div>
                <label htmlFor="phone" className="block text-sm font-medium text-foreground mb-1">Телефон *</label>
                <input id="phone" name="phone" type="tel" required placeholder="+7 (___) ___-__-__" className="w-full rounded-lg border border-line bg-background px-4 py-3 text-base focus:ring-2 focus:ring-ring focus:border-gold-text outline-none focus-visible:outline-2 focus-visible:outline-[#6E5530] focus-visible:outline-offset-2 transition-shadow" />
              </div>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              <div>
                ...
                <input id="date" name="date" type="date" className="w-full rounded-lg border border-line bg-background px-4 py-3 text-base focus:ring-2 focus:ring-ring focus:border-gold-text outline-none focus-visible:outline-2 focus-visible:outline-[#6E5530] focus-visible:outline-offset-2 transition-shadow" />
              </div>
              <div>
                <label htmlFor="guests" className="block text-sm font-medium text-foreground mb-1">Кол-во гостей на дегустацию</label>
                <input id="guests" name="guests" type="number" min="1" max="12" defaultValue="2" className="w-full rounded-lg border border-line bg-background px-4 py-3 text-base focus:ring-2 focus:ring-ring focus:border-gold-text outline-none focus-visible:outline-2 focus-visible:outline-[#6E5530] focus-visible:outline-offset-2 transition-shadow" />
              </div>
            </div>
            ...
            <div>
              ...
              <select id="eventFormat" name="eventFormat" className="w-full rounded-lg border border-line bg-background px-4 py-3 text-base focus:ring-2 focus:ring-ring focus:border-gold-text outline-none focus-visible:outline-2 focus-visible:outline-[#6E5530] focus-visible:outline-offset-2 transition-shadow">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full rounded-lg border border-line bg-background px-4 py-3 text-base focus:ring-2 focus:ring-ring focus:border-gold-text outline-none focus-visible:outline-2 focus-visible:outline-[#6E5530] focus-visible:outline-offset-2 transition-shadow resize-none"
              />
            </div>
