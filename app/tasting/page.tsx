          ...
          <form className="space-y-4" action="/api/quote" method="POST">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  name="name"
                  required
                  className="border-line bg-background focus:ring-ring focus:border-gold-text w-full rounded-lg border px-4 py-3 text-base transition-shadow outline-none focus:ring-2 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#6E5530]"
                />
              </div>
              <div>
            ...
            <div>
              ...
              <textarea
                ...
                className="border-line bg-background focus:ring-ring focus:border-gold-text w-full resize-none rounded-lg border px-4 py-3 text-base transition-shadow outline-none focus:ring-2 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#6E5530]"
              />
            </div>
