...
const TEAM = [
  ...
  },
  {
    name: "Елена Соколова",
    role: "Шеф-кондитер",
    bio: "Десерты — её страсть. Выпускница Le Cordon Bleu (Париж, диплом Patisserie 2012, копия по запросу). Специализация: свадебные торты, безглютеновая выпечка, веганские десерты.",
    experience: "С 2012 года",
    credentials: ["Le Cordon Bleu (копия диплома по запросу)", "Санминимум", "Медкнижка", "Безглютеновая сертификация"],
    initials: "ЕС",
  ...
  },
  {
    ...
    credentials: ["Санминимум", "Медкнижка", "Менеджмент событий (курс ВАВШ)", "Координатор 120+ событий"],
    initials: "МВ",
  ...
  },
  {
    ...
    credentials: ["Санминимум", "Медкнижка", "Тендерная практика (44-ФЗ/223-ФЗ)", "ЭДО Диадок+СБИС"],
    initials: "ИП",
      ...
      <div className="container-site max-w-5xl">
        ...
        <div className="border-line bg-secondary/30 mx-auto mb-6 max-w-2xl rounded-lg border p-3 text-center">
          <p className="text-muted-foreground text-xs italic">
            <strong>Основатель и шеф-повар Дмитрий Нилов</strong> — реальное фото. Портреты других
            членов команды — стилизованные SVG-иллюстрации; индивидуальные фотографии предоставляются
            по запросу. Все ФИО и роли — реальные сотрудники NiloV Catering.
          </p>
        </div>
