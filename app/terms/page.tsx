...
export const metadata: Metadata = {
  alternates: { canonical: '/terms', languages: { 'ru': '/terms', 'en': '/en', 'x-default': '/terms' } },
      ...
      <div className="container-site max-w-3xl">
        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <p className="text-sm leading-relaxed">
              7.3. Опоздание доставки — доставка должна быть в согласованное окно: ±15 минут для кофе-брейков и конференций, ±30 минут для банкетов. Штраф 1% за каждую минуту опоздания, начиная с 1-й (максимум 30% от суммы заказа). Для B2B-клиентов с SLA-договором — расширенные санкции по индивидуальному соглашению.
            </p>
          </section>
