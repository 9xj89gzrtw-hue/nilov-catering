      ...
      <div className="container-site max-w-3xl">
        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <p className="text-sm leading-relaxed">
              7.3. Опоздание доставки — доставка должна быть точно в согласованное окно. Штраф 1% за каждую минуту опоздания, начиная с 1-й (максимум 30% от суммы заказа). Для B2B-клиентов с SLA-договором — расширенные санкции по индивидуальному соглашению.
            </p>
          </section>
