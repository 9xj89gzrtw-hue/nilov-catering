        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <p className="text-sm leading-relaxed mb-3">
              ...
              <strong>Исключение — срочные поминальные обеды</strong>: принимаем заявки в день обращения
              (24 часа) при наличии свободной смены поваров. Поминки — особый случай, мы не требуем 3 дня.
              Другие форматы (свадьбы, корпоративы) — строго 3+ дня.
            </p>
            <p className="text-sm leading-relaxed">
              2.3. Дегустация бесплатна для событий от 30 гостей. Стоимость дегустации —
          ...
          <section>
            ...
            <p className="text-sm leading-relaxed mb-3">
              ...
              мероприятия по акту. ЭДО (Диадок, СБИС) — обязательно. Депозит 30% от стоимости
              заказа бронирует дату и входит в предоплату 50%. Для постоянных B2B-клиентов
              (3+ событий) — отсрочка 14 рабочих дней.
            </p>
            <p className="text-sm leading-relaxed mb-3">
            ...
            <p className="text-sm leading-relaxed">
              3.4. Скидки: 5% при бронировании за 30+ дней, 10% за 60+ дней, 15% за 90+ дней. Объёмные скидки:
              от 50 гостей — 5%, от 100 гостей — 10%, от 200 гостей — 15%, от 500 гостей — индивидуально.
              Для многодневных конференций (2+ дня) — пакетная цена со скидкой 20%. Для школ и учреждений —
              спец. тариф от 1 800 ₽/гость. Полная таблица — см. /faq.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-sm leading-relaxed">
              7.3. Опоздание доставки — доставка должна быть в согласованное окно: ±15 минут для всех форматов (банкет, фуршет, кофе-брейк, доставка). Штраф 1% за каждую минуту опоздания, начиная с 1-й (максимум 30% от суммы заказа). Для B2B-клиентов с SLA-договором — расширенные санкции по индивидуальному соглашению.
            </p>
          </section>
