  ...
  return (
    <main className="pt-24 pb-20"><div className="container-site">
      ...
      <p className="text-center text-sm text-muted-foreground mb-12 max-w-xl mx-auto p-3 rounded-lg bg-blue-50 border border-blue-200">
        📍 <strong>Иногородним клиентам:</strong> поможем подобрать площадку в СПб под ваш
        формат и бюджет. Присылайте параметры — пришлём 3-5 вариантов с фото и ценой.
        Связь: <a href="tel:+78129195911" className="underline text-gold-text">+7 (812) 919-59-11</a>{' '}
