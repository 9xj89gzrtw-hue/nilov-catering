...
const CASES = [
  ...
  },
  {
    ...
    desc: 'Банкет по тарифу «Стандарт» (5 470 ₽/гость). Свадебный торт на заказ, винная карта, координатор дня. Подача по таймингу ±5 мин. Отзыв: 5,0 .',
...
const CERTS = [
  ...
  { icon: BadgeCheck, title: 'Халяль — СМР', desc: 'Совет муфтиев России, рег. № СМР-Халяль (скан по запросу) (до 31.12.2026).' },
  { icon: Wheat, title: 'Безглютеновое <20 ppm', desc: 'Тестирование по стандарту GFCO. Отдельная посуда и инвентарь.' },
  { icon: ShieldCheck, title: 'Страхование ГО 5–30 млн ₽', desc: 'ведущие страховые компании РФ. Базовый 5 млн ₽, расширение до 30 млн ₽.' },
      ...
      <div className="relative h-[60vh] min-h-[420px] md:h-[72vh] md:min-h-[560px] overflow-hidden">
        ...
        <div className="relative h-full container-site flex flex-col justify-end pb-12 md:pb-16">
          ...
          >
            ...
            Команда 40+ человек, 3 000+ событий, 4.8★ .
          </motion.p>
          <motion.div
            initial={reducedMotion ? false : { opacity: 1, y: 16 }}
            animate={{ opacity: 1, y: 0 }}
