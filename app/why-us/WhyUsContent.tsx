...
const TEAM = [
  ...
  },
  {
    ...
    role: 'Шеф халяль-линии',
    photo: '/images/catering/staff-03.jpg',
    photoAlt: 'Алексей Воронов, шеф халяль-линии NiloV Catering',
    bio: 'Контролирует зибха, раздельное оборудование, сертификацию СМР (рег. № СМР-Халяль-2026-142). Личный контакт с Советом муфтиев России.',
    meta: 'С 2014 года',
  },
  {
    name: 'Мария Кузнецова',
    role: 'B2B-менеджер, координатор',
    photo: '/images/catering/staff-05.jpg',
    photoAlt: 'Мария Кузнецова, B2B-менеджер и координатор NiloV Catering',
    bio: 'Ведёт тендеры (44-ФЗ, 223-ФЗ), ЭДО-документы, договоры. Прямой мобильный для партнёров с NDA. SLA-договоры и страхование.',
    meta: 'С 2016 года',
  },
];
