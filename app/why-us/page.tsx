...
export const metadata: Metadata = {
  ...
  title: 'Почему мы',
  description: 'NiloV Catering — кейтеринг в Петербурге с 2007 года. 27 отзывов · 4.8/5. Дмитрий Нилов (шеф), команда 40+ чел. Ресторанное качество по реальной цене.',
};
      ...
      <div className="container-site max-w-3xl">
        ...
        <div className="prose prose-stone max-w-none space-y-6 text-muted-foreground">
          ...
          <p>
            ...
            От семейного ужина на 10 персон до фестиваля на 800+ гостей (с расширением производственных мощностей).
          </p>
          ...
          <div className="space-y-4 not-prose">
            ...
            <div className="p-5 rounded-xl border-2 border-gold-text/40 bg-gold-text/5">
              <p className="text-xs text-muted-foreground mb-1">
                Май 2025 · Конгресс-холл «Экспофорум», СПб · 3 сертифицированные кухни
              </p>
              ...
              <p className="text-sm text-foreground/90">
                ...
                Субподряд — 3 сертифицированные кухни (список предоставлен
