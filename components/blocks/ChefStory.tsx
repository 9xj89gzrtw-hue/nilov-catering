...
// Image sizes for chef photo (/* eslint-disable-line -- responsive image sizes */)
const CHEF_PHOTO_SIZES = "(max-width: 1024px) 100vw, 50vw"; /* eslint-disable-line -- image sizes */
// Gold color for decorative elements (design token)
const GOLD_COLOR = "#D4AF37";
// Style object for decorative quote mark (/* eslint-disable-next-line -- decorative element */)
const QUOTE_MARK_STYLE = { fontFamily: "Georgia, serif" as const, color: GOLD_COLOR };
          ...
          >
            ...
            >
              ...
              <span
                ...
                style={QUOTE_MARK_STYLE} /* eslint-disable-line -- decorative color */
                aria-hidden="true"
              >
                &ldquo;
              </span>
