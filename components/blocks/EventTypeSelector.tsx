...
const EVENTS: { format: Format; href: string; price: string; label: string; desc?: string }[] = [
  { format: 'banket', href: '/events/korporativ', price: 'от 3 950 ₽', label: 'Корпоративы', desc: 'Деловые обеды, банкеты, тимбилдинги' },
  ...
  { format: 'banket', href: '/events/chastnoe', price: 'от 3 950 ₽', label: 'Частное', desc: 'Дни рождения, юбилеи, семейные ужины' },
