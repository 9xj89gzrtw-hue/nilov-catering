...
const EVENTS: { format: Format; href: string; price: string; label: string; desc?: string }[] = [
  { format: 'banket', href: '/events/korporativ', price: 'от 4 470 ₽', label: 'Корпоративы', desc: 'Деловые обеды, банкеты, тимбилдинги' },
  { format: 'banket', href: '/events/svadba', price: 'от 4 470 ₽', label: 'Свадьбы', desc: 'От камерной до банкета на 200 гостей' },
  { format: 'furshet', href: '/events/vypusknoy', price: 'от 2 450 ₽', label: 'Выпускные', desc: 'Школьные и студенческие мероприятия' },
  { format: 'banket', href: '/events/chastnoe', price: 'от 4 470 ₽', label: 'Частное', desc: 'Дни рождения, юбилеи, семейные ужины' },
  { format: 'detskoe', href: '/events/detskoe', price: 'от 1 950 ₽', label: 'Детское', desc: 'Меню для детей, аниматоры, шоу' },
