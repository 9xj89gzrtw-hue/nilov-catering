              ...
              >
                ...
                <div className="relative aspect-[4/3] overflow-hidden">
                  {e.photoUrl ? (
                    ...
                    <picture>
                      <source
                        srcSet={`/images/real/${e.photo}-480.avif 480w, /images/real/${e.photo}-768.avif 768w, /images/real/${e.photo}.avif 1920w`}
                        sizes="(max-width: 768px) 100vw, (max-width: 1280px) 50vw, 25vw"
                        type="image/avif"
                      />
                      <source
                        srcSet={`/images/real/${e.photo}-480.webp 480w, /images/real/${e.photo}-768.webp 768w, /images/real/${e.photo}.webp 1920w`}
                        sizes="(max-width: 768px) 100vw, (max-width: 1280px) 50vw, 25vw"
                        type="image/webp"
                      />
                      {/* eslint-disable-next-line @next/next/no-img-element */}
