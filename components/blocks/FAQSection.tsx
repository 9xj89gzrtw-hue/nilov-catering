...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "Стандартная схема: аванс 50% при подписании договора, остаток — за день до события. Принимаем наличные, банковский перевод. ИП Нилов Д.И. применяет УСН (без НДС). Для плательщиков НДС (ОСН) оформляем через партнёрское ООО. Для корпоративных клиентов возможна отсрочка платежа.",
  },
  {
