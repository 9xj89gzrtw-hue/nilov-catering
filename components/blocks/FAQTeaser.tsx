...
const FAQS = [
  {
    ...
    a: 'Минимум зависит от формата и тарифа. Кофе-брейк — от 10 гостей × 390 ₽ = 3 900 ₽ (Эконом). Фуршет — от 20 гостей × 2 450 ₽ = 49 000 ₽ (Эконом); Расширенный от 15 × 5 950 ₽ = 89 250 ₽. Банкет — от 30 × 3 950 ₽ = 118 500 ₽ (Эконом свадебный); Максимальный от 15 × 9 950 ₽ = 149 250 ₽. Точную сумму рассчитает калькулятор за 30 секунд.',
  },
  {
