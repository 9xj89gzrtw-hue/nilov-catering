...
// Animation constants
const STAGGER_CHILDREN_DELAY = 0.08; // Delay between staggered children
const DELAY_CHILDREN = 0.1; // Initial delay before children animate
const ITEM_ANIMATION_DURATION = 0.5; // Duration for item entrance animation
const HEADER_ANIMATION_DURATION = 0.6; // Duration for header animation
const INVIEW_MARGIN = "-60px"; // Margin for intersection observer
const ITEM_INITIAL_Y = 24; // Initial Y offset for items
const ITEM_INITIAL_SCALE = 0.96; // Initial scale for items

// Animation variants
const containerVariants = {
  hidden: {},
  visible: {
    transition: { staggerChildren: STAGGER_CHILDREN_DELAY, delayChildren: DELAY_CHILDREN },
  },
};

const itemVariants = {
  hidden: { opacity: 0, y: ITEM_INITIAL_Y, scale: ITEM_INITIAL_SCALE },
  visible: {
    opacity: 1,
    y: 0,
    scale: 1,
    transition: { duration: ITEM_ANIMATION_DURATION, ease: "easeOut" as const },
  },
};
