  ...
  return (
    <div className="mb-12 p-6 rounded-xl border border-line bg-card text-center">
      ...
      <form className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto" action="/api/newsletter" method="POST">
        ...
        <input id="newsletter-email" type="email" name="email" autoComplete="email" placeholder="Ваш email" required className="flex-1 rounded-lg border border-line bg-background px-4 py-2.5 text-sm" />
