...
export function KenBurnsCard({
  ...
  return (
    <motion.div
      className={`group border-line bg-card hover:border-gold-text hover:shadow-gold/10 overflow-hidden rounded-xl border transition-shadow duration-300 hover:shadow-lg ${className}`}
      whileHover={{ y: -4 }}
