...
export const LEGAL: {
  ...
  vatStatus:
    'Работаем по безналу с юрлицами на УСН (без НДС). Для клиентов на ОСН, требующих счёт-фактуру с НДС, partnerское ООО выставляет документы — уточняйте у менеджера.',
