...
const STATION_IMAGES: Record<string, string[]> = {
  cold: [
    `${IMG_BASE}/kanape/k1.jpg`,
    `${IMG_BASE}/kanape/k2.jpg`,
    `${IMG_BASE}/kanape/k3.jpg`,
    `${IMG_BASE}/kanape/k4.jpg`,
    `${IMG_BASE}/kanape/k5.jpg`,
    `${IMG_BASE}/kanape/k6.jpg`,
    `${IMG_BASE}/kanape/k7.jpg`,
    `${IMG_BASE}/kanape/k8.jpg`,
    `${IMG_BASE}/kanape/k9.jpg`,
    `${IMG_BASE}/salaty/s1.jpg`,
    `${IMG_BASE}/salaty/s2.jpg`,
    `${IMG_BASE}/salaty/s3.jpg`,
    `${IMG_BASE}/salaty/s4.jpg`,
    `${IMG_BASE}/salaty/s5.jpg`,
    `${IMG_BASE}/salaty/s6.jpg`,
    `${IMG_BASE}/salaty/s7.jpg`,
    `${IMG_BASE}/salaty/s8.jpg`,
    `${IMG_BASE}/salaty/s9.jpg`,
  ],
  hot: [
    `${IMG_BASE}/goryachee/h1.jpg`,
    `${IMG_BASE}/goryachee/h2.jpg`,
    `${IMG_BASE}/goryachee/h3.jpg`,
    `${IMG_BASE}/goryachee/h4.jpg`,
    `${IMG_BASE}/goryachee/h5.jpg`,
    `${IMG_BASE}/goryachee/h6.jpg`,
    `${IMG_BASE}/goryachee/h7.jpg`,
    `${IMG_BASE}/goryachee/h8.jpg`,
    `${IMG_BASE}/bbq/b1.jpg`,
    `${IMG_BASE}/bbq/b2.jpg`,
    `${IMG_BASE}/bbq/b3.jpg`,
    `${IMG_BASE}/bbq/b4.jpg`,
  ...
  desserts: [
    `${IMG_BASE}/deserty/d1.jpg`,
    `${IMG_BASE}/deserty/d2.jpg`,
    `${IMG_BASE}/deserty/d3.jpg`,
    `${IMG_BASE}/deserty/d4.jpg`,
    `${IMG_BASE}/deserty/d5.jpg`,
    `${IMG_BASE}/deserty/d6.jpg`,
    `${IMG_BASE}/deserty/d7.jpg`,
    `${IMG_BASE}/deserty/d8.jpg`,
    `${IMG_BASE}/deserty/d9.jpg`,
    `${IMG_BASE}/sezonnye/se4.jpg`,
    `${IMG_BASE}/sezonnye/se5.jpg`,
    `${IMG_BASE}/sezonnye/se6.jpg`,
    `${IMG_BASE}/sezonnye/se7.jpg`,
  ],
  drinks: [
    `${IMG_BASE}/napitki/n1.jpg`,
    `${IMG_BASE}/napitki/n2.jpg`,
    `${IMG_BASE}/napitki/n3.jpg`,
    `${IMG_BASE}/napitki/n4.jpg`,
  ],
  show: [
    `${IMG_BASE}/sezonnye/se1.jpg`,
    `${IMG_BASE}/sezonnye/se2.jpg`,
    `${IMG_BASE}/sezonnye/se3.jpg`,
    `${IMG_BASE}/sezonnye/se6.jpg`,
    `${IMG_BASE}/bbq/b3.jpg`,
    `${IMG_BASE}/bbq/b4.jpg`,
  ],
  bbq: [
    ...
    `${IMG_BASE}/bbq/b4.jpg`,
    `${IMG_BASE}/bbq/b5.jpg`,
    `${NEW_DISHES}/halal-chicken-shashlik.jpg`,
    `${NEW_DISHES}/halal-lamb-kofta.jpg`,
    `${NEW_DISHES}/halal-kebab-plate.jpg`,
    `${NEW_DISHES}/beef-steak.jpg`,
  ],
};
...
export const GALLERY_IMAGES = [
  // === События (9 фото) ===
  {
    ...
    caption: "Свадьба · 120 гостей · Особняк Бруноз · Август 2024",
  },
  {
    src: "/images/gallery/corporate-furshet.jpg",
    alt: "Корпоративный фуршет",
    caption: "Корпоратив · 300 гостей · Лофт «Севкабель» · Декабрь 2024",
  },
  {
    src: "/images/gallery/dessert-table.jpg",
    alt: "Десертный стол",
    caption: "Десертная станция · свадьба · Июль 2024",
  },
  {
    src: "/images/gallery/cocktail.jpg",
    alt: "Коктейльный бар",
    caption: "Бармен-шоу · корпоратив · 50 чел",
  },
  {
    src: "/images/gallery/show-station.jpg",
    alt: "Шоу-станция",
    caption: "Живая станция · конференция Expoforum · Октябрь 2024",
  },
  {
    src: "/images/gallery/furshet-menu.jpg",
    alt: "Фуршетное меню",
    caption: "Канапе и закуски · фуршет на 80 чел",
  },
  {
    src: "/images/gallery/banket.jpg",
    alt: "Банкет",
    caption: "Банкет под ключ · юбилей · 25 чел",
  },
  {
    src: "/images/gallery/kids.jpg",
    alt: "Детский праздник",
    caption: "Детский праздник · БГ-меню · 8 детей · Ноябрь 2025",
  },
  {
    src: "/images/gallery/servirovka.jpg",
    alt: "Сервировка",
    caption: "Авторская сервировка · свадьба · 60 чел",
  },

  // === Канапе (9 фото) ===
  {
    src: "/images/menu/kanape/k1.jpg",
    alt: "Канапе с лососем",
    caption: "Канапе с лососем · фуршет",
  },
  {
    src: "/images/menu/kanape/k2.jpg",
    alt: "Канапе с сыром",
    caption: "Канапе с сыром и орехом · фуршет",
  },
  {
    src: "/images/menu/kanape/k3.jpg",
    alt: "Канапе капрезе",
    caption: "Канапе капрезе · моцарелла, томаты, песто",
  },
  {
    src: "/images/menu/kanape/k4.jpg",
    alt: "Канапе с хамоном",
    caption: "Канапе с хамоном · премиум-фуршет",
  },
  {
    src: "/images/menu/kanape/k5.jpg",
    alt: "Тарталетки с курицей",
    caption: "Тарталетка с курицей · фуршет",
  },
  {
    src: "/images/menu/kanape/k6.jpg",
    alt: "Тарталетки с грибами",
    caption: "Тарталетка грибная · фуршет",
  },
  {
    src: "/images/menu/kanape/k7.jpg",
    alt: "Брускетта с томатами",
    caption: "Брускетта с томатами · веган · фуршет",
  },
  {
    src: "/images/menu/kanape/k8.jpg",
    alt: "Рулетик из лаваша",
    caption: "Рулет из лаваша · фуршет",
  },
  {
    src: "/images/menu/kanape/k9.jpg",
    alt: "Канапе ассорти",
    caption: "Канапе-ассорти · 5 видов · фуршет",
  },
  ...
  {
    src: "/images/menu/salaty/s3.jpg",
    alt: "Буррата с томатами",
    caption: "Буррата с томатами · банкет",
  },
  ...
  {
    src: "/images/menu/salaty/s6.jpg",
    alt: "Салат с лососем",
    caption: "Салат с лососем · банкет",
  },
  ...
  {
    src: "/images/menu/salaty/s9.jpg",
    alt: "Греческий салат",
    caption: "Греческий салат · фуршет",
  },

  // === Горячее (8 фото) ===
  { src: "/images/menu/goryachee/h1.jpg", alt: "Мини-бургер", caption: "Мини-бургер · фуршет" },
  {
    src: "/images/menu/goryachee/h2.jpg",
    alt: "Куриные якитори",
    caption: "Куриные якитори · фуршет",
  },
  {
    src: "/images/menu/goryachee/h3.jpg",
    alt: "Овощи гриль",
    caption: "Овощи гриль · веган · халяль",
  },
  { src: "/images/menu/goryachee/h4.jpg", alt: "Бефстроганов", caption: "Бефстроганов · банкет" },
  {
    src: "/images/menu/goryachee/h5.jpg",
    alt: "Медальоны из вырезки",
    caption: "Медальоны из говядины · банкет",
  },
  {
    src: "/images/menu/goryachee/h6.jpg",
    alt: "Форель",
    caption: "Форель с картофельным муссом · банкет",
  },
  {
    src: "/images/menu/goryachee/h7.jpg",
    alt: "Курица с киноа",
    caption: "Курица с киноа · банкет",
  },
  { src: "/images/menu/goryachee/h8.jpg", alt: "Борщ", caption: "Борщ · банкет" },

  // === BBQ (5 фото) ===
  {
    src: "/images/menu/bbq/b1.jpg",
    alt: "Джерк-курица на плантане",
    caption: "Джерк-курица · гриль · фуршет",
  },
  {
    src: "/images/menu/bbq/b2.jpg",
    alt: "Тайские мясные шарики",
    caption: "Мясные шарики с чили · фуршет",
  },
  {
    src: "/images/menu/bbq/b3.jpg",
    alt: "Бао с томлёной свининой",
    caption: "Бао · паровые булочки · фуршет",
  },
  { src: "/images/menu/bbq/b4.jpg", alt: "Бао с уткой", caption: "Бао с уткой · премиум-фуршет" },
  {
    src: "/images/menu/bbq/b5.jpg",
    alt: "Бургер из грибов и бобов",
    caption: "Вегетарианский бургер · веган",
  },

  // === Десерты (9 фото) ===
  {
    src: "/images/menu/deserty/d1.jpg",
    alt: "Макаронс",
    caption: "Макаронс-шутер · десертная станция",
  },
  ...
  {
    src: "/images/menu/deserty/d4.jpg",
    alt: "Шоколадный мусс",
    caption: "Шоколадный мусс · веган · без сахара · СД1",
  },
  {
    src: "/images/menu/deserty/d5.jpg",
    alt: "Чиа-пудинг",
    caption: "Чиа-пудинг · веган · без сахара · СД1",
  },
  { src: "/images/menu/deserty/d6.jpg", alt: "Брауни", caption: "Брауни-шутер · кофе-брейк" },
  {
    src: "/images/menu/deserty/d7.jpg",
    alt: "Печенье-шутер",
    caption: "Молочно-печенье-шутер · детский",
  },
  {
    src: "/images/menu/deserty/d8.jpg",
    alt: "Мини-тарт",
    caption: "Мини-тарт ассорти · кофе-брейк",
  },
  {
    src: "/images/menu/deserty/d9.jpg",
    alt: "Шоколадный брауни",
    caption: "Шоколадный брауни · фуршет",
  },

  // === Напитки (4 фото) ===
  {
    src: "/images/menu/napitki/n1.jpg",
    alt: "Облепиховый чай",
    caption: "Облепиховый чай · без сахара · кофе-брейк",
  },
  {
    src: "/images/menu/napitki/n2.jpg",
    alt: "Клюквенный морс",
    caption: "Клюквенный морс · без сахара · кофе-брейк",
  },
  ...
  // === Сезонные (7 фото) ===
  {
    src: "/images/menu/sezonnye/se1.jpg",
    alt: "Сезонное блюдо 1",
    caption: "Сезонная закуска · весна 2025",
  },
  {
    src: "/images/menu/sezonnye/se2.jpg",
    alt: "Сезонное блюдо 2",
    caption: "Сезонный салат · лето 2025",
  },
  {
    src: "/images/menu/sezonnye/se3.jpg",
    alt: "Сезонное блюдо 3",
    caption: "Сезонное горячее · осень 2024",
  },
  {
    src: "/images/menu/sezonnye/se4.jpg",
    alt: "Сезонное блюдо 4",
    caption: "Сезонный десерт · зима 2024",
  },
  {
    src: "/images/menu/sezonnye/se5.jpg",
    alt: "Сезонное блюдо 5",
    caption: "Праздничное блюдо · Новый год 2025",
  },
  {
    src: "/images/menu/sezonnye/se6.jpg",
    alt: "Сезонное блюдо 6",
    caption: "Сезонная выпечка · осень 2025",
  },
  {
    src: "/images/menu/sezonnye/se7.jpg",
    alt: "Сезонное блюдо 7",
    caption: "Десерт фестивальный · 2025",
  },
];
...
export function getDishImageByIndex(
  dishId: string,
...
export const REAL_GALLERY_IMAGES = [
  // Original real photos
  {
    ...
    alt: "Свадебный банкет",
    caption: "Свадебный банкет · 100 гостей · Загородный отель",
  },
  {
    src: "/images/real/corporate-buffet.jpg",
    alt: "Корпоративный буфет",
    caption: "Корпоратив · 150 гостей · Бизнес-центр",
  },
  {
    src: "/images/real/canape-platter.jpg",
    alt: "Канапе плато",
    caption: "Канапе-плато · 8 видов · фуршет",
  },
  {
    src: "/images/real/dessert-table.jpg",
    alt: "Десертный стол",
    caption: "Десертная станция · свадьба",
  },
  {
    src: "/images/real/beef-medallions.jpg",
    alt: "Медальоны из говядины",
    caption: "Медальоны из вырезки · банкет",
  },
  { src: "/images/real/poke-bowl.jpg", alt: "Поке-боул", caption: "Поке с лососем · фуршет" },
  {
    src: "/images/real/macarons.jpg",
    alt: "Макаронс",
    caption: "Французские макаронс · кофе-брейк",
  },
  {
  ...
  {
    src: "/images/real/chocolate-mousse.jpg",
    alt: "Шоколадный мусс",
    caption: "Десерт · веган · без сахара",
  },
  {
    src: "/images/real/vegetarian-bowl.jpg",
    alt: "Вегетарианский боул",
    caption: "Будда-боул · веган · фуршет",
  },
  {
    src: "/images/real/cranberry-juice.jpg",
    alt: "Клюквенный морс",
    caption: "Авторские напитки · кофе-брейк",
  },
  { src: "/images/real/coffee-drink.jpg", alt: "Кофе", caption: "Кофейная станция · конференция" },

  // AI-generated premium gallery images (2026)
  {
    src: "/images/gallery/wedding-banquet-luxury.jpg",
    alt: "Роскошный свадебный банкет",
    caption: "Свадьба премиум-класса · белоснежный текстиль · хрусталь и золото",
  },
  {
    src: "/images/gallery/corporate-event-modern.jpg",
    alt: "Современный корпоративный ивент",
    caption: "Корпоратив в лофт-пространстве · современный дизайн · 200+ гостей",
  },
  {
    src: "/images/gallery/dessert-table-elegant.jpg",
    alt: "Элегантный десертный стол",
    caption: "Десертная станция · торт-каскад · макаронная башня · шоколадный фонтан",
  },
  {
    src: "/images/gallery/cocktail-reception.jpg",
    alt: "Коктейльная рецепция",
    caption: "Бармен-шоу · авторские коктели · элегантная подача",
  },
  {
    src: "/images/gallery/chef-show-cooking.jpg",
    alt: "Шоу-станция шеф-повара",
    caption: "Живая готовка · огненное шоу · интерактивная станция",
  },
  {
  ...
  },
  {
    ...
    alt: "Банкетный зал",
    caption: "Банкетный зал · круглые столы · люстры · роскошная сервировка",
  },
  {
  ...
  },
  {
    ...
    alt: "Кофе-брейк для бизнеса",
    caption: "Кофейная станция · эспрессо-бар · выпечка · деловой завтрак",
  },
  {
    src: "/images/gallery/kids-party-colorful.jpg",
    alt: "Детский праздник",
    caption: "Детское меню · яркие оформления · фруктовые фигурки · веселье",
  },
  {
    src: "/images/gallery/table-setting-details.jpg",
    alt: "Детали сервировки",
    caption: "Авторская сервировка · детали имеют значение · люкс-сопровождение",
  },
];
