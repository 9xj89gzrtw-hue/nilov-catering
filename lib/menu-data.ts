...
const PREMIUM_EXTRA: Dish[] = [
  ...
  { id: "gf-pizza", name: "Безглютеновая мини-пицца (с миндалём)", description: "Основа из миндальной муки, томаты, моццарелла, базилик. Без пшеничной муки, <20 ppm.', image: '', station: 'hot', format: ['furshet', 'detskoe'], tier: ['standard', 'premium', 'luxury'], pricePerGuest: 240, servingsPerGuest: 2, allergens: ['milk'], dietBadges: ['gluten-free'], childFriendly: true },
