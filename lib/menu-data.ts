...
const GRAZING: Dish[] = [
  ...
  { id: 'cheese-platter', name: 'Сырная тарелка', description: 'Камамбер, маасдам, пармезан, мёд, орехи', image: '', station: 'cold', format: ['furshet', 'banket'], tier: ['standard', 'premium', 'luxury'], pricePerGuest: 420, servingsPerGuest: 1, allergens: ['milk', 'nuts'], dietBadges: ['gluten-free'], childFriendly: true },
...
const DESSERTS: Dish[] = [
  ...
  { id: 'donut-wall', name: 'Донат-стена', description: 'Мини-донаты с глазурью, оформление стеной (может содержать следы орехов)', image: '', station: 'desserts', format: ['furshet', 'banket', 'detskoe'], tier: ['standard', 'premium', 'luxury'], pricePerGuest: 180, servingsPerGuest: 1, allergens: ['gluten', 'eggs', 'milk', 'nuts'], dietBadges: [], childFriendly: true },
  ...
  { id: 'brownie-shooter', name: 'Брауни-шутер', description: 'Шоколадный брауни в стакане с карамелью (с грецким орехом)', image: '', station: 'desserts', format: ['furshet', 'banket', 'coffee-break', 'detskoe'], tier: ['standard', 'premium', 'luxury'], pricePerGuest: 190, servingsPerGuest: 1, allergens: ['gluten', 'eggs', 'milk', 'nuts'], dietBadges: [], childFriendly: true },
...
const FURSHET_EXTRA: Dish[] = [
  ...
  { id: 'chocolate-brownie', name: 'Шоколадный брауни', description: 'Классический брауни с грецким орехом', image: '', station: 'desserts', format: ['furshet', 'coffee-break', 'detskoe'], tier: ['economy', 'standard', 'premium', 'luxury'], pricePerGuest: 160, servingsPerGuest: 1, allergens: ['gluten', 'eggs', 'milk', 'nuts'], dietBadges: [], childFriendly: true },
];
...
const PREMIUM_EXTRA: Dish[] = [
  ...
  { id: 'wine-red', name: 'Вино красное', description: 'Красное сухое: Кьянти/Риоха/Кот дю Рон', image: '', station: 'drinks', format: ['furshet', 'banket'], tier: ['standard', 'premium', 'luxury'], pricePerGuest: 350, servingsPerGuest: 2, allergens: ['sulphites'], dietBadges: ['vegan', 'gluten-free'], childFriendly: false },
  { id: 'wine-white', name: 'Вино белое', description: 'Белое сухое: Соаве/Альбариньо/Шабли', image: '', station: 'drinks', format: ['furshet', 'banket'], tier: ['standard', 'premium', 'luxury'], pricePerGuest: 320, servingsPerGuest: 2, allergens: ['sulphites'], dietBadges: ['vegan', 'gluten-free'], childFriendly: false },
  { id: 'champagne', name: 'Шампанское', description: 'Игристое брют, просекко', image: '', station: 'drinks', format: ['furshet', 'banket'], tier: ['premium', 'luxury'], pricePerGuest: 450, servingsPerGuest: 2, allergens: ['sulphites'], dietBadges: ['vegan', 'gluten-free'], childFriendly: false },
  { id: 'champagne-premium', name: 'Шампанское премиум', description: 'Шампанское AOC, брют/розе', image: '', station: 'drinks', format: ['furshet', 'banket'], tier: ['luxury'], pricePerGuest: 850, servingsPerGuest: 1, allergens: ['sulphites'], dietBadges: ['vegan', 'gluten-free'], childFriendly: false },
  ...
  { id: 'whisky-bar', name: 'Виски-бар', description: 'Коллекция виски: бурбон, скотч, ирландский, японский', image: '', station: 'drinks', format: ['furshet', 'banket'], tier: ['luxury'], pricePerGuest: 700, servingsPerGuest: 1, allergens: [], dietBadges: ['vegan', 'gluten-free'], childFriendly: false },
  ...
  { id: 'gf-pizza', name: 'Безглютеновая мини-пицца', description: 'Основа из миндальной муки, томаты, моццарелла, базилик. Без пшеничной муки, <20 ppm.', image: '', station: 'hot', format: ['furshet', 'detskoe'], tier: ['standard', 'premium', 'luxury'], pricePerGuest: 240, servingsPerGuest: 2, allergens: ['milk'], dietBadges: ['gluten-free'], childFriendly: true },
