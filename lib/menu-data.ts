...
const PREMIUM_EXTRA: Dish[] = [
  ...
  { id: 'pizza-margherita', name: 'Пицца Маргарита (30 см)', description: 'Томатный соус, моццарелла, базилик, оливковое масло. 8 кусков.', image: '', station: 'hot', format: ['furshet', 'detskoe'], tier: ['economy', 'standard', 'premium'], pricePerGuest: 400, servingsPerGuest: 1, allergens: ['gluten', 'milk'], dietBadges: ['vegetarian'], childFriendly: true },
  ...
  { id: 'pizza-quattro', name: 'Пицца Четыре сыра (30 см)', description: 'Моццарелла, горгонзола, пармезан, рикотта, мёд. 8 кусков.', image: '', station: 'hot', format: ['furshet', 'banket'], tier: ['premium', 'luxury'], pricePerGuest: 550, servingsPerGuest: 1, allergens: ['gluten', 'milk'], dietBadges: ['vegetarian'], childFriendly: true },
