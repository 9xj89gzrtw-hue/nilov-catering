...
const GLOBAL_SMALL_PLATES: Dish[] = [
  ...
  { id: 'poke-salmon', name: 'Поке с лососем и авокадо', description: 'Рис, лосось, авокадо, эдамамэ, соус понзу', image: '', station: 'cold', format: ['furshet', 'banket'], tier: ['premium', 'luxury'], pricePerGuest: 420, servingsPerGuest: 1, allergens: ['fish', 'soy', 'sesame'], dietBadges: ['gluten-free'], childFriendly: false },
...
const DESSERTS: Dish[] = [
  ...
  { id: 'donut-wall', name: 'Донат-стена', description: 'Мини-донаты с глазурью, оформление стеной', image: '', station: 'desserts', format: ['furshet', 'banket', 'detskoe'], tier: ['standard', 'premium', 'luxury'], pricePerGuest: 180, servingsPerGuest: 1, allergens: ['gluten', 'eggs', 'milk'], dietBadges: [], childFriendly: true },
  ...
  { id: 'brownie-shooter', name: 'Брауни-шутер', description: 'Шоколадный брауни в стакане с карамелью', image: '', station: 'desserts', format: ['furshet', 'banket', 'coffee-break', 'detskoe'], tier: ['standard', 'premium', 'luxury'], pricePerGuest: 190, servingsPerGuest: 1, allergens: ['gluten', 'eggs', 'milk'], dietBadges: [], childFriendly: true },
...
const FURSHET_EXTRA: Dish[] = [
  ...
  { id: 'yakitori', name: 'Куриные якитори', description: 'Шпажки в соусе терияки с кунжутом', image: '', station: 'hot', format: ['furshet', 'detskoe'], tier: ['standard', 'premium', 'luxury'], pricePerGuest: 220, servingsPerGuest: 1, allergens: ['soy', 'sesame'], dietBadges: [], childFriendly: true },
