...
const FURSHET_EXTRA: Dish[] = [
  ...
  { id: 'veggie-grill', name: 'Овощи гриль (веган, халяль)', description: 'Баклажан, перец, цуккини, шампиньоны. Без животных жиров — подходит для веган и халяль-меню.', image: '', station: 'hot', format: ['furshet', 'banket'], tier: ['economy', 'standard', 'premium', 'luxury'], pricePerGuest: 200, servingsPerGuest: 1, allergens: [], dietBadges: ['vegan', 'gluten-free', 'halal'], childFriendly: true },
