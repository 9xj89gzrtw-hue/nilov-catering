...
const DRINKS: Dish[] = [
  ...
  { id: 'cedar-raf', name: 'Кедровый раф', description: 'Кофейный напиток с кедровым молоком', image: '', station: 'drinks', format: ['furshet', 'banket', 'coffee-break'], tier: ['standard', 'premium', 'luxury'], pricePerGuest: 150, servingsPerGuest: 1, allergens: ['milk'], dietBadges: ['gluten-free'], childFriendly: false },
