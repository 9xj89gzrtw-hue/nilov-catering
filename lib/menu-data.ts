...
const GLOBAL_SMALL_PLATES: Dish[] = [
  ...
  { id: 'taco-cauliflower', name: 'Мини-тако с цветной капустой', description: 'Кукурузная тортилья, цветная капуста с чимичурри, веган. ХЕ=1, БЖУ: белки 3 г / жиры 5 г / углеводы 12 г.', image: '', station: 'hot', format: ['furshet'], tier: ['standard', 'premium', 'luxury'], pricePerGuest: 280, servingsPerGuest: 1, allergens: [], dietBadges: ['vegan', 'gluten-free'], childFriendly: true },
...
const PLANT_BASED: Dish[] = [
  ...
  { id: 'veggie-ragout', name: 'Овощное рагу', description: 'Сезонные овощи, томатный соус, базилик. ХЕ=1, БЖУ: белки 3 г / жиры 4 г / углеводы 12 г.', image: '', station: 'hot', format: ['banket', 'detskoe'], tier: ['economy', 'standard', 'premium', 'luxury'], pricePerGuest: 250, servingsPerGuest: 1, allergens: [], dietBadges: ['vegan', 'gluten-free'], childFriendly: true },
  { id: 'buddha-bowl', name: 'Будда-боул с тофу', description: 'Киноа, тофу, авокадо, эдамамэ, мисо-дрессинг. ХЕ=2, БЖУ: белки 14 г / жиры 12 г / углеводы 24 г.', image: '', station: 'cold', format: ['furshet', 'banket'], tier: ['standard', 'premium', 'luxury'], pricePerGuest: 380, servingsPerGuest: 1, allergens: ['soy', 'sesame'], dietBadges: ['vegan', 'gluten-free'], childFriendly: true },
];
...
const DESSERTS: Dish[] = [
  ...
  { id: 'choc-mousse', name: 'Шоколадный мусс (веган, без добавленного сахара)', description: 'Из авокадо и тёмного шоколада 70%. Без добавленного сахара — подходит для СД1 (учитывайте натуральный сахар какао: 6 г углеводов на порцию). ХЕ=0.5, БЖУ: белки 3 г / жиры 12 г / углеводы 6 г.', image: '', station: 'desserts', format: ['furshet', 'banket', 'detskoe'], tier: ['standard', 'premium', 'luxury'], pricePerGuest: 190, servingsPerGuest: 1, allergens: [], dietBadges: ['vegan', 'gluten-free', 'sugar-free'], childFriendly: true },
  { id: 'chia-pudding', name: 'Веррин чиа-пудинг (без добавленного сахара)', description: 'Кокосовое молоко, чиа, маракуйя. Без добавленного сахара — подходит для СД1. ХЕ=1, БЖУ: белки 4 г / жиры 8 г / углеводы 12 г.', image: '', station: 'desserts', format: ['furshet', 'banket', 'detskoe'], tier: ['standard', 'premium', 'luxury'], pricePerGuest: 170, servingsPerGuest: 1, allergens: [], dietBadges: ['vegan', 'gluten-free', 'sugar-free'], childFriendly: true },
...
const DRINKS: Dish[] = [
  { id: 'seabuckthorn-tea', name: 'Облепиховый чай с имбирём', description: 'Согревающий чай с облепихой и имбирём. Без добавленного сахара. ХЕ=0.5 на порцию.', image: '', station: 'drinks', format: ['furshet', 'banket', 'coffee-break'], tier: ['economy', 'standard', 'premium', 'luxury'], pricePerGuest: 120, servingsPerGuest: 2, allergens: [], dietBadges: ['vegan', 'gluten-free', 'sugar-free'], childFriendly: true },
  { id: 'cranberry-mors', name: 'Клюквенный морс с мятой', description: 'Домашний морс из клюквы с мятой и лаймом. Без добавленного сахара. ХЕ=0.5 на порцию.', image: '', station: 'drinks', format: ['furshet', 'banket', 'coffee-break'], tier: ['economy', 'standard', 'premium', 'luxury'], pricePerGuest: 100, servingsPerGuest: 2, allergens: [], dietBadges: ['vegan', 'gluten-free', 'sugar-free'], childFriendly: true },
  ...
  { id: 'lemonade-tarragon', name: 'Лимонад эстрагон', description: 'Авторский лимонад с эстрагоном и лаймом. Без добавленного сахара. ХЕ=0.5 на порцию.', image: '', station: 'drinks', format: ['furshet', 'banket', 'coffee-break', 'detskoe'], tier: ['economy', 'standard', 'premium', 'luxury'], pricePerGuest: 100, servingsPerGuest: 2, allergens: [], dietBadges: ['vegan', 'gluten-free', 'sugar-free'], childFriendly: true },
  { id: 'lemonade-berry', name: 'Лимонад ягодный', description: 'Микс ягод, лимон, мята, содовая. Без добавленного сахара. ХЕ=0.5 на порцию.', image: '', station: 'drinks', format: ['furshet', 'banket', 'coffee-break', 'detskoe'], tier: ['economy', 'standard', 'premium', 'luxury'], pricePerGuest: 110, servingsPerGuest: 2, allergens: [], dietBadges: ['vegan', 'gluten-free', 'sugar-free'], childFriendly: true },
  { id: 'kombucha', name: 'Комбуча', description: 'Ферментированный чайный напиток', image: '', station: 'drinks', format: ['furshet', 'banket'], tier: ['standard', 'premium', 'luxury'], pricePerGuest: 140, servingsPerGuest: 1, allergens: [], dietBadges: ['gluten-free'], childFriendly: false },
...
const FURSHET_EXTRA: Dish[] = [
  { id: 'canape-salmon', name: 'Канапе с лососем', description: 'Сливочный сыр, лосось, укроп. ХЕ=0.5, БЖУ: белки 4 г / жиры 5 г / углеводы 6 г.', image: '', station: 'cold', format: ['furshet'], tier: ['economy', 'standard', 'premium', 'luxury'], pricePerGuest: 190, servingsPerGuest: 2, allergens: ['fish', 'milk', 'gluten'], dietBadges: [], childFriendly: true },
  ...
  { id: 'bruschetta-tomato', name: 'Брускетта с томатами', description: 'Чиабатта, томаты, базилик, чеснок. ХЕ=1, БЖУ: белки 3 г / жиры 4 г / углеводы 14 г.', image: '', station: 'cold', format: ['furshet'], tier: ['economy', 'standard', 'premium', 'luxury'], pricePerGuest: 140, servingsPerGuest: 1, allergens: ['gluten'], dietBadges: [], childFriendly: true },
  ...
  { id: 'veggie-grill', name: 'Овощи гриль (веган, халяль)', description: 'Баклажан, перец, цуккини, шампиньоны. Без животных жиров — подходит для веган и халяль-меню. ХЕ=1, БЖУ: белки 2 г / жиры 5 г / углеводы 10 г.', image: '', station: 'hot', format: ['furshet', 'banket'], tier: ['economy', 'standard', 'premium', 'luxury'], pricePerGuest: 200, servingsPerGuest: 1, allergens: [], dietBadges: ['vegan', 'gluten-free', 'halal'], childFriendly: true },
...
const BANKET_EXTRA: Dish[] = [
  ...
  { id: 'caesar', name: 'Салат Цезарь', description: 'Романо, курица, пармезан, гренки. ХЕ=1, БЖУ: белки 18 г / жиры 15 г / углеводы 12 г.', image: '', station: 'cold', format: ['banket'], tier: ['economy', 'standard', 'premium', 'luxury'], pricePerGuest: 320, servingsPerGuest: 1, allergens: ['gluten', 'milk', 'eggs', 'fish'], dietBadges: [], childFriendly: true },
  { id: 'salmon-salad', name: 'Салат с лососем и авокадо', description: 'Микс салатов, лосось, авокадо. ХЕ=0.5, БЖУ: белки 22 г / жиры 18 г / углеводы 6 г.', image: '', station: 'cold', format: ['banket'], tier: ['standard', 'premium', 'luxury'], pricePerGuest: 380, servingsPerGuest: 1, allergens: ['fish'], dietBadges: ['gluten-free'], childFriendly: false },
...
const COFFEE_BREAK_EXTRA: Dish[] = [
  ...
  { id: 'fruit-platter', name: 'Фруктовая тарелка', description: 'Сезонные фрукты с низким ГИ: клубника, киви, черника, грейпфрут. Без добавленного сахара. ХЕ=1.5, БЖУ: белки 1 г / жиры 0 г / углеводы 18 г.', image: '', station: 'cold', format: ['coffee-break', 'furshet', 'detskoe'], tier: ['economy', 'standard', 'premium', 'luxury'], pricePerGuest: 200, servingsPerGuest: 1, allergens: [], dietBadges: ['vegan', 'gluten-free', 'sugar-free'], childFriendly: true },
];
...
const KIDS: Dish[] = [
  ...
  { id: 'fruit-canape', name: 'Фруктовые канапе (низкий ГИ)', description: 'Клубника, киви, черника — фрукты с низким гликемическим индексом, подходят для СД1. Без банана и винограда. ХЕ=0.5, БЖУ: белки 1 г / жиры 0 г / углеводы 7 г.', image: '', station: 'cold', format: ['detskoe', 'furshet'], tier: ['economy', 'standard', 'premium', 'luxury'], pricePerGuest: 140, servingsPerGuest: 1, allergens: [], dietBadges: ['vegan', 'gluten-free', 'sugar-free'], childFriendly: true },
  { id: 'pancakes', name: 'Панкейки', description: 'Мини-панкейки с ягодным соусом. Возможна версия без добавленного сахара — попросите менеджера (подходит для СД1).', image: '', station: 'desserts', format: ['detskoe'], tier: ['economy', 'standard', 'premium', 'luxury'], pricePerGuest: 150, servingsPerGuest: 1, allergens: ['gluten', 'eggs', 'milk'], dietBadges: [], childFriendly: true },
  ...
  { id: 'kids-fruit', name: 'Фруктовое ассорти', description: 'Нарезка свежих фруктов с низким ГИ: клубника, киви, черника. Без банана и винограда. ХЕ=1, БЖУ: белки 1 г / жиры 0 г / углеводы 12 г.', image: '', station: 'cold', format: ['detskoe'], tier: ['economy', 'standard', 'premium', 'luxury'], pricePerGuest: 160, servingsPerGuest: 1, allergens: [], dietBadges: ['vegan', 'gluten-free', 'sugar-free'], childFriendly: true },
];
...
const HALAL: Dish[] = [
  { id: 'halal-chicken-shashlik', name: 'Шашлык из курицы (халяль)', description: 'Куриное бедро в маринаде из йогурта и специй, мангал. Без свинины, без алкоголя. ХЕ=0.5, БЖУ: белки 22 г / жиры 12 г / углеводы 6 г.', image: '', station: 'hot', format: ['furshet', 'banket'], tier: ['standard', 'premium', 'luxury'], pricePerGuest: 380, servingsPerGuest: 1, allergens: ['milk'], dietBadges: ['halal'], childFriendly: true },
  ...
  { id: 'halal-plov', name: 'Плов с говядиной (халяль)', description: 'Узбекский плов с говядиной халяль, морковь, нут, зира. Без свинины. ХЕ=2, БЖУ: белки 18 г / жиры 12 г / углеводы 24 г.', image: '', station: 'hot', format: ['banket'], tier: ['standard', 'premium', 'luxury'], pricePerGuest: 450, servingsPerGuest: 1, allergens: [], dietBadges: ['halal', 'gluten-free'], childFriendly: true },
  ...
  { id: 'halal-hummus', name: 'Хумус с питой (веганский, халяль)', description: 'Нут, тахини, лимон, чеснок. Подаётся с тёплой питой. Без животных жиров. ХЕ=1.5, БЖУ: белки 6 г / жиры 8 г / углеводы 18 г.', image: '', station: 'cold', format: ['furshet', 'banket'], tier: ['standard', 'premium', 'luxury'], pricePerGuest: 180, servingsPerGuest: 1, allergens: ['gluten', 'sesame'], dietBadges: ['halal', 'vegan'], childFriendly: true },
  { id: 'halal-fattoush', name: 'Салат фаттуш (веганский, халяль)', description: 'Овощи, зелень, обжаренная пита, сумах. Без животных жиров. ХЕ=1, БЖУ: белки 3 г / жиры 5 г / углеводы 14 г.', image: '', station: 'cold', format: ['furshet', 'banket'], tier: ['standard', 'premium', 'luxury'], pricePerGuest: 200, servingsPerGuest: 1, allergens: ['gluten'], dietBadges: ['halal', 'vegan'], childFriendly: true },
  ...
  { id: 'halal-tabouleh', name: 'Табуле (веганский, халяль)', description: 'Булгур, петрушка, мята, томаты, лимон. Без животных жиров. ХЕ=1, БЖУ: белки 3 г / жиры 2 г / углеводы 12 г.', image: '', station: 'cold', format: ['furshet', 'banket'], tier: ['standard', 'premium', 'luxury'], pricePerGuest: 190, servingsPerGuest: 1, allergens: ['gluten'], dietBadges: ['halal', 'vegan'], childFriendly: true },
  ...
  { id: 'halal-lentil-soup', name: 'Чечевичный суп (веганский, халяль)', description: 'Красная чечевица, томаты, зира, лимон. Без животных жиров. ХЕ=1.5, БЖУ: белки 8 г / жиры 2 г / углеводы 18 г.', image: '', station: 'hot', format: ['furshet', 'banket'], tier: ['economy', 'standard', 'premium', 'luxury'], pricePerGuest: 180, servingsPerGuest: 1, allergens: [], dietBadges: ['halal', 'vegan', 'gluten-free'], childFriendly: true },
  // 'halal-grilled-veg' объединён с 'veggie-grill' (одинаковые ингредиенты, добавлен badge halal)
];
...
const PREMIUM_EXTRA: Dish[] = [
  ...
  { id: 'canape-cheese', name: 'Канапе с сыром', description: 'Сыр дор-блю, грецкий орех, медовые соты на крекере. ХЕ=1, БЖУ: белки 4 г / жиры 8 г / углеводы 10 г.', image: '', station: 'cold', format: ['furshet', 'banket'], tier: ['economy', 'standard', 'premium', 'luxury'], pricePerGuest: 170, servingsPerGuest: 2, allergens: ['milk', 'nuts', 'gluten'], dietBadges: [], childFriendly: true },
  ...
  { id: 'tartlet-chicken', name: 'Тарталетка куриная', description: 'Копчёная курица, вяленые томаты, сливочный мусс. ХЕ=0.5, БЖУ: белки 4 г / жиры 5 г / углеводы 6 г.', image: '', station: 'cold', format: ['furshet', 'banket'], tier: ['economy', 'standard', 'premium', 'luxury'], pricePerGuest: 160, servingsPerGuest: 1, allergens: ['gluten', 'eggs', 'milk'], dietBadges: [], childFriendly: true },
  ...
  { id: 'wine-sommelier', name: 'Wine pairing (5 вин)', description: 'Сомелье + 5 вин с рассказом о каждом, подобранных под меню', image: '', station: 'show', format: ['furshet', 'banket'], tier: ['luxury'], pricePerGuest: 1200, servingsPerGuest: 1, allergens: ['sulphites'], dietBadges: [], childFriendly: false },
  ...
  { id: 'beer-craft', name: 'Крафтовое пиво', description: 'Крафтовое пиво: IPA, стаут, пшеничное', image: '', station: 'drinks', format: ['furshet', 'banket'], tier: ['standard', 'premium', 'luxury'], pricePerGuest: 280, servingsPerGuest: 2, allergens: ['gluten'], dietBadges: [], childFriendly: false },
  ...
  { id: 'pizza-margherita', name: 'Пицца Маргарита (30 см)', description: 'Томатный соус, моццарелла, базилик, оливковое масло. 8 кусков.', image: '', station: 'hot', format: ['furshet', 'detskoe'], tier: ['economy', 'standard', 'premium'], pricePerGuest: 400, servingsPerGuest: 1, allergens: ['gluten', 'milk'], dietBadges: [], childFriendly: true },
  { id: 'pizza-pepperoni', name: 'Пицца Пепперони (30 см)', description: 'Томатный соус, моццарелла, пепперони, орегано. 8 кусков.', image: '', station: 'hot', format: ['furshet', 'detskoe'], tier: ['standard', 'premium'], pricePerGuest: 480, servingsPerGuest: 1, allergens: ['gluten', 'milk'], dietBadges: [], childFriendly: true },
  { id: 'pizza-quattro', name: 'Пицца Четыре сыра (30 см)', description: 'Моццарелла, горгонзола, пармезан, рикотта, мёд. 8 кусков.', image: '', station: 'hot', format: ['furshet', 'banket'], tier: ['premium', 'luxury'], pricePerGuest: 550, servingsPerGuest: 1, allergens: ['gluten', 'milk'], dietBadges: [], childFriendly: true },
  { id: 'pizza-vegan', name: 'Веганская пицца (30 см)', description: 'Томатный соус, веганский сыр, овощи гриль, базилик. 8 кусков. Без молока, без яиц.', image: '', station: 'hot', format: ['furshet', 'detskoe'], tier: ['standard', 'premium'], pricePerGuest: 500, servingsPerGuest: 1, allergens: ['gluten'], dietBadges: ['vegan'], childFriendly: true },
];
