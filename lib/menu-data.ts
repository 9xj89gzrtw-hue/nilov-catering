...
const DESSERTS: Dish[] = [
  ...
  { id: 'choc-mousse', name: 'Шоколадный мусс (веган, без сахара)', description: 'Из авокадо и тёмного шоколада 70%. Без добавленного сахара — подходит для СД1.', image: '', station: 'desserts', format: ['furshet', 'banket', 'detskoe'], tier: ['standard', 'premium', 'luxury'], pricePerGuest: 190, servingsPerGuest: 1, allergens: [], dietBadges: ['vegan', 'gluten-free', 'sugar-free'], childFriendly: true },
  { id: 'chia-pudding', name: 'Веррин чиа-пудинг (без сахара)', description: 'Кокосовое молоко, чиа, маракуйя. Без добавленного сахара — подходит для СД1.', image: '', station: 'desserts', format: ['furshet', 'banket', 'detskoe'], tier: ['standard', 'premium', 'luxury'], pricePerGuest: 170, servingsPerGuest: 1, allergens: [], dietBadges: ['vegan', 'gluten-free', 'sugar-free'], childFriendly: true },
