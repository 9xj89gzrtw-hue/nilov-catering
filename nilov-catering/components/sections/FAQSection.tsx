...
const faqs = [
  ...
  },
  {
    ...
    a: "Мы работаем по всему Санкт-Петербургу и Ленинградской области. Для мероприятий за пределами Ленинградской области рассчитывается индивидуальная логистическая доплата.",
  },
];
