...
const features = [
  {
    ...
    description: "Каждое блюдо разрабатывается шеф-поваром Дмитрием Ниловым лично. Мы не используем полуфабрикаты — только свежие продукты и оригинальные рецепты.",
  },
  {
    icon: Leaf,
    title: "Свежие локальные продукты",
    description: "Работаем с проверенными фермерскими хозяйствами Ленинградской области. Сезонные ингредиенты, короткая цепочка поставок от поля к вашему столу.",
  },
  {
    icon: HeartHandshake,
  ...
  },
  {
    ...
    description: "19 лет опыта позволяют нам рассчитать тайминг каждого мероприятия с хирургической точностью. Никаких задержек и накладок.",
  },
  {
    icon: Award,
