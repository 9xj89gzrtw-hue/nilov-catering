...
export const testimonials: Testimonial[] = [
  {
    ...
    event: "Свадьба на крыше, 80 гостей",
    rating: 5,
    text: "Фуршет на крыше в центре Петербурга — это было волшебно! Гости до сих пор вспоминают канапе с тигровой креветкой и икрой летучей рыбы. Отдельное спасибо за чёрный текстиль в сервировке — выглядело невероятно стильно.",
    avatar: AVATARS[0],
    date: "2025-09-15",
  },
  {
    id: "2",
    name: "Артём Сидоров",
    event: "Презентация Emporio Armani, 120 гостей",
    rating: 5,
    text: "Обслуживали презентацию нового запаха для Emporio Armani. Уровень сервиса и качество подачи соответствовали статусу мероприятия. Горячие закуски и канапе были безупречны.",
    avatar: AVATARS[1],
    date: "2025-06-20",
  },
  {
    ...
    event: "Защита диссертации, 40 гостей",
    rating: 5,
    text: "Организовали фуршет для преподавателей на защите диссертации в университете. Всё прошло гладко, professors были довольны. Профессиональный подход и внимание к деталям сервировки.",
    avatar: AVATARS[2],
    date: "2025-03-15",
  },
  },
  {
    id: "4",
    name: "Павел Громов",
    event: "Корпоратив на корабле, 60 гостей",
    rating: 5,
    text: "Выездной фуршет с горячими закусками на корабле — один из самых романтичных форматов, которые мы пробовали. Команда arrived заранее, всё было готово. Качество блюд на высоте.",
    avatar: AVATARS[3],
    date: "2024-09-22",
  },
  {
    id: "5",
    name: "Мария Козлова",
    event: "Свадьба в лофте, 100 гостей",
    rating: 5,
    text: "Дмитрий подобрал идеальное меню с учётом наших пожеланий и бюджета. Куриный рулет су-вид и брускетта с лососем стали хитами вечера. Флористическое сопровождение в подарок — приятный сюрприз!",
    avatar: AVATARS[4],
    date: "2024-08-10",
  },
  {
    id: "6",
    name: "Игорь Дмитриев",
    event: "Юбилей в загородном доме, 50 гостей",
    rating: 5,
    text: "Заказывали выездной банкет загородом. На welcome — шампанское и канапе, на ужин — мясо на мангале. Чувствовали себя как в настоящем ресторане. Уже третий раз заказываем!",
    avatar: AVATARS[5],
    date: "2024-07-23",
  },
];
