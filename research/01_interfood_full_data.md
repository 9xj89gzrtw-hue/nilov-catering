...
- Доставка закусок: /menu/dostavka-zakusok/
- Вегетарианское: /menu/vegetarianskoe/
- Барбекю: /menu/bbq/ (или /barbekyu/)
...
- Выездной банкет: /uslugi/vyezdnoj-banket/
- Выездной ресторан: /uslugi/vyezdnoj-restaurant/
- Оформление зала: /uslugi/oformlenie-zala/
- Торты на заказ: /uslugi/torty-na-zakaz/
- Пирамиды из шампанского: /uslugi/piramidy-iz-shampanskogo/
- Новогодний корпоратив: /uslugi/novogodnij-korporativ/
...
- [ ] Отзывы
- [ ] Фотогалерея
- [ ] Услуги (все 10 страниц)
- [ ] Контакты

## ИЗВЛЕЧЁННЫЕ ДАННЫЕ ПО СТРАНИЦАМ:

(будут добавлены по мере парсинга)
