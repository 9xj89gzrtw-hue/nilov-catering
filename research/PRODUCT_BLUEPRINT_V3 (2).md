...
interface SelectedItem { id: string; name: string; pricePerGuest: number; quantity: number; category: string; }
interface AddOn { id: string; name: string; price: number; quantity: number; unit: 'fixed' | 'per-guest'; description: string; }
```
