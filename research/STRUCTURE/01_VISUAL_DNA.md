...
>
> Drinkit — кофейное приложение Dodo Brands (App Store, 4.9★, 278 оценок) ✅ _(реальный сайт-эталон, проверено FactChecker)_. Заказчик
...
- **H1/H2/H3:** Cormorant (serif, 300–700; _italic_ для акцентных слов, включая кириллицу при наличии глифа) [Волна 15, A-R1/B-C1: Cormorant OSS, самохост, distinctive вместо generic Playfair].
