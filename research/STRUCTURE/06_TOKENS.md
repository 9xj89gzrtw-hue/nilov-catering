...
@theme {
  --font-heading:
    "Cormorant", ui-serif, Georgia, serif; /* заголовки (КАНОН: Cormorant, НЕ Playfair — см. 01 §3, 44) */
...
@theme {
  ...
  --shadow-card: 0 8px 24px -12px rgba(28, 24, 21, 0.12);
  --shadow-soft: 0 20px 50px -20px rgba(28, 24, 21, 0.18);
  --shadow-hover: 0 28px 60px -24px rgba(28, 24, 21, 0.24);
  --shadow-gold-glow: 0 0 40px rgba(176, 141, 87, 0.1);
...
```css
@theme {
  --ease-out-expo: cubic-bezier(0.22, 1, 0.36, 1); /* reveals, slide-in */
  --ease-spring: cubic-bezier(0.34, 1.56, 0.64, 1); /* countUp, magnetic */
  --dur-fast: 200ms;
  --dur-base: 400ms;
  --dur-slow: 700ms;
