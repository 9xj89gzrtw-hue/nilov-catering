...
- `33_UXSIM_DARYA.md:14` — «Кофе-брейк от 950 ₽» 🟡 _(канон spec; живой сайт NiloV «от 390 ₽» — BUG-F2, требует сверки с прайсом заказчика до публикации)_. Рекомендация #7 (стр.67-68) дублирует предупреждение о расхождении 950 vs 390.
- `33_UXSIM_MARINA.md:12` — «Кофе-брейк от 950 ₽ 🟡 _(канон spec; живой сайт «от 390 ₽», BUG-F2)_». Флаг присутствует прямо в Hero-строке.
